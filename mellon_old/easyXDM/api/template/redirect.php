            ...
            $(function () {
                setTimeout(function () {
                    if (!window.bridgePresenceCheckSkip && (!window.parent || !window.parent.bridge)) {
                        window.location.href = '../?msid=<?php echo $_SESSION['mellon_msid']; ?>&msname=msid';
                    }
                }, 4000);
            });
            ...
            <script type="text/javascript">
                $(function () {
                    ...
                    $btn.on('click', function () {
                        window.parent.bridge.redirect({url: '<?php echo $lobby_url; ?>api/login.php?token=<?php echo md5($_SESSION['mellon_msid']); ?>&msid=<?php echo $_SESSION['mellon_msid']; ?>&msname=msid'});
