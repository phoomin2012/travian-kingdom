<script type="text/ng-template" id="tpl/map.html"><div ng-controller="mapCtrl" id="map" touch-tooltips force-touch-tooltips="true" class="mapContainer">
			...
			<div class="filters" ng-show="filters.showFilters">
				<div class="content">
					<div ng-if="zoomLevel != 2">
						...
						<div class="option" ng-if="config.balancing.features.treasuresOnMap">
							<label>
								<input type="checkbox" ng-model="filters.villageTreasures" ng-change="setFilter('villageTreasures', filters.villageTreasures)"/>
		...
		<div class="mainLayoutMenuButton directionTo goToButton" ng-class="{active: goToLocation.show}">
			...
			<div class="filters" ng-show="goToLocation.show">
				<div class="content">
					...
					<serverautocomplete
						autocompletedata="village,playerVillages,kingdomVillages,coords,emptyCoords"
	...
	<div id="overlayMarkers" class="zoomLevel{{zoomLevel+1}}">
		...
		<div class="villageTreasuries" ng-style="obj.style" ng-repeat="(id, obj) in villageTreasures track by id">
			<div class="content">
				<span class="inner"><i class="unit_treasure_small_flat_black"></i>{{obj.treasures | number: 0}}</span>
			</div>
		</div>
		...
		<div class="fieldMarker unselectable" ng-if="zoomLevel == 0 && obj.markers.length > 0" ng-style="obj.style" ng-repeat="(id, obj) in fieldMarkers track by id" id="fieldMarker{{id}}"
			 ng-class="{'hasNavigation': obj.markers.length > 1, 'minimizedMarker': obj.minimized, 'allianceWide': obj.markers[obj.selectedMarker].data.allianceId > 0, 'personal': obj.markers[obj.selectedMarker].data.allianceId == 0 && obj.markers[obj.selectedMarker].data.isGlobal == 0 && obj.markers[obj.selectedMarker].data.creatorPlayerId != -1}">
			...
			<div ng-if="!obj.minimized" class="wrapper fieldMarkerBox">
				...
				<div class="content" clickable="fieldMarkerToggle(obj);">
					<span ng-if="obj.markers[obj.selectedMarker].data.isGlobal == 1"
						  ...
						  class="global">?</span>
					<span ng-if="obj.markers[obj.selectedMarker].data.isGlobal == 0 && obj.markers[obj.selectedMarker].data.creatorPlayerId != -1" class="personal">
					...
					<span ng-if="obj.markers[obj.selectedMarker].data.isGlobal == 0 && obj.markers[obj.selectedMarker].data.creatorPlayerId == -1" class="global"
						  translate
						  data="timeAgo:{{obj.markers[obj.selectedMarker].timeAgo}}"
						  options="{{obj.markers[obj.selectedMarker].data.text}}">?</span>
		...
		<div class="clouds tutorial_mapOverlay_illustration" id="tutorialClouds" ng-if="player.data.spawnedOnMap == 0">
	...
	<div id="tileInformation" class="contentBox unselectable" id="tileInformationPosition" ng-style="tiStyle" ng-class="{coordsOnly: tiInfos.coordsOnly}">
		...
		<div class="contentBoxBody resources unselectable" ng-if="zoomLevel != 2 && (tiInfos.resDistribution || tiInfos.robberVillageDetails || tiInfos.oasis || tiInfos.playerName)">
			...
			<span class="owner">
				<span ng-if="tiInfos.oasis && tiInfos.oasis.oasisStatus == Village.OASIS_STATUS_OCCUPIED">
					...
					<kingdom-link class="disabled" kingdomId="{{tiInfos.oasis.kingdomId}}" nolink="true"></kingdom-link>
				</span>
				...
				<span ng-if="tiInfos.kingdomId > 0">
					(<kingdom-link kingdomId="{{tiInfos.kingdomId}}" nolink="true"></kingdom-link>)
				</span>
			</span>
		...
		<div class="reportsContainer unselectable" ng-if="tiInfos.report">
			<div class="reportsDecoration unselectable">
				<span class="inner">
					<i class="reportIcon reportTypes_reportIcon{{tiInfos.report.notificationType}}"></i>
...
<script type="text/ng-template" id="tpl/resources.html"><div ng-controller="villageViewCtrl" ng-init="setCurrentView('resources')" class="resources viewBackground" touch-tooltips zoom min-height="800" min-width="1174" offset-height="20" org-width="1920" org-height="1440">
	<div class="resDistribution resources{{resDistribution}}">
		<div class="waterfallAnimation"></div>
	</div>
...
<script type="text/ng-template" id="tpl/village.html"><div ng-controller="villageViewCtrl" ng-init="setCurrentView('village')" class="village viewBackground" touch-tooltips ng-class="{'village-water': isTown}" zoom min-height="950" min-width="1174" offset-height="40" org-width="1920" org-height="1440">
	<div id="villageView" class="villageView" ng-class="{wwVillage: isWWVillage}">
		<div class="waterAnimationIncoming"></div>
		<div class="waterAnimationOutgoing"></div>
		<div class="fishJumpAnimation"></div>
...
<script type="text/ng-template" id="tpl/building/embassy/overlay/kingdom/AbdicateConfirmation.html"><span translate ng-show="!dukeCandidate.playerId">Embassy.Communities.Popup.AbdicateConfirmationDescription.NoDuke</span>
<span translate data="playerId: {{dukeCandidate.playerId}}, playerName: {{dukeCandidate.playerName}}" ng-show="dukeCandidate.playerId">Embassy.Communities.Popup.AbdicateConfirmationDescription.Duke</span>
<span translate data="hours:{{coronationDuration}}">Embassy.Communities.Popup.AbdicateConfirmationDescription.NextCoronationTime</span>
...
<div class="buttonFooter">
	<button clickable="confirmAbdicate();" ng-class="{disabled: currentPlayer.data.hasNoobProtection}">
		<span translate>Embassy.Communities.Kingdom.Button.abdicate</span>
	</button>
...
<div class="contentBox transparent tag">
	<h6 class="contentBoxHeader headerColored" translate>Kingdom.NameYourKingdom</h6>

	<div class="contentBoxBody">
		<input type="text" maxlength="8" ng-model="form.tag" placeholder="{{placeHolderKingdomTag}}">
	</div>
</div>
	...
	<div class="inWindowPopupContent">
		<div class="contentBox transparent">
			<h6 class="contentBoxHeader headerColored">
				<span translate ng-if="invitation.data.invitedAs==Player.KINGDOM_ROLE_GOVERNOR">Embassy.Communities.Popup.Kingdom.Invitations.Governor.Title</span>
				...
				<div class="sender">
					<span translate>Embassy.Communities.Popup.Kingdom.Invitations.From</span>
					<span player-link playerId="{{invitation.data.invitedBy}}"
								 playerName="{{invitation.data.invitedByName}}"></span>
				</div>
			</h6>
			<div class="contentBoxBody">
				<span translate data="playerId:{{invitation.data.invitedBy}},playerName:{{invitation.data.invitedByName}},kingdomId:{{invitation.data.groupId}},kingdomName:{{invitation.data.groupName}}" ng-if="invitation.data.invitedAs==Player.KINGDOM_ROLE_GOVERNOR">
					Embassy.Communities.Popup.Kingdom.Invitations.InvitationText
				</span>
				<span translate data="playerId:{{invitation.data.invitedBy}},playerName:{{invitation.data.invitedByName}},kingdomId:{{invitation.data.groupId}},kingdomName:{{invitation.data.groupName}}" ng-if="invitation.data.invitedAs==Player.KINGDOM_ROLE_DUKE">
		...
		<div class="buttonFooter">
			...
			<button class="cancel" clickable="declineInvitation();">
...
<script type="text/ng-template" id="tpl/building/embassy/overlay/kingdom/kingdomInvitationOverview.html"><div class="invitationOverview" scrollable>
	<kingdom-invitation-list></kingdom-invitation-list>
</div></script>
...
<script type="text/ng-template" id="tpl/building/embassy/partials/Kingdom.html"><div ng-controller="embassyKingdomCtrl" class="embassyKingdom">
	<h6 class="headerWithIcon arrowDirectionDown contentBoxHeader">
		...
		<a clickable="openOverlay('kingdomInvitation');"
		   ...
		   ng-class="{disabled: invitations.data.length <= 0}" ng-if="coronationStatus == Player.CORONATION_STATUS.NONE">
			<span translate data="amount: {{invitations.data.length}}">Embassy.Communities.Kingdom.Invitations</span>
	...
	<div class="contentBoxBody detailsContent"
		...
		<span translate ng-if="user.data.kingdomId == 0">Embassy.Communities.Kingdom.noKingdom</span>
		...
		<div ng-if="user.data.kingdomId > 0" class="membership contentBox gradient">
			<h6 class="contentBoxHeader headerWithArrowEndings" ng-class="{glorious: coronationStatus == Player.CORONATION_STATUS.CROWNED}">
				<div class="content">
					<kingdom-link kingdomId="{{user.data.kingdomId}}" kingdomName="{{kingdom.data.tag}}" nolink="true"></kingdom-link>
				</div>
	...
	<div ng-if="coronationStatus == Player.CORONATION_STATUS.NONE"
		...
		<div class="footerContent">
					...
					<tr>
						...
						<td ng-if="!treasuryAvailable && !player.data.hasNoobProtection && player.data.kingdomRole != Player.KINGDOM_ROLE_DUKE">
							...
							<div>
								...
								<a clickable="openWindow('help', {'pageId': 'Buildings_' + Building.TYPE.HIDDEN_TREASURY})" translate options="{{Building.TYPE.HIDDEN_TREASURY}}">Building_?</a>
							</div>
						</td>
						<td ng-if="treasuryAvailable && !player.data.hasNoobProtection && player.data.kingdomRole != Player.KINGDOM_ROLE_DUKE"><span translate>Embassy.Communities.HiddenTreasury</span></td>
						<td ng-if="player.data.hasNoobProtection">
							<span translate>Embassy.Communities.StillInNoobProtection</span>
						</td>
						<td ng-if="!player.data.hasNoobProtection && player.data.kingdomRole == Player.KINGDOM_ROLE_DUKE">
							<span translate>Embassy.Communities.IsDuke</span>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<button class="jsQuestButtonCoronation"
					...
					ng-if="!isSitter && player.data.deletionTime <= 0"
					ng-class="{disabled: !treasuryAvailable || player.data.kingdomRole == Player.KINGDOM_ROLE_DUKE || player.data.hasNoobProtection}">
				<span translate>Embassy.Communities.Kingdom.Button.foundKingdom</span>
			</button>
			<button class="jsQuestButtonCoronation disabled"
					tooltip
					tooltip-translate="Feature.NotPossibleInDeletion"
					ng-if="player.data.deletionTime > 0">
				<span translate>Embassy.Communities.Kingdom.Button.foundKingdom</span>
			</button>
			<button class="jsQuestButtonCoronation disabled"
					tooltip
...
<script type="text/ng-template" id="tpl/building/embassy/subtabs/CommunitiesNavigation.html"><nav class="tabulation {{tabData.tabName}} {{tabData.tabType}}" ng-if="tabData.tabs.length > 1">
	<a class="tab clickableContainer"
	   ...
	   play-on-click="{{UISound.BUTTON_SQUARE_CLICK}}">
		...
		<i class="selection_arrow_illu arrow" ng-show="tab == tabData.currentTab"></i>
	</a>
</nav>
				...
				<tbody>
					<tr ng-repeat="oasis in oasesInReach" ng-class="{disabled: oasis.isWild}">
						...
						<td class="kingdom">
							...
							<span ng-show="oasis.kingdomId != 0"><span player-link playerId="{{oasis.kingId}}" playername=""></span></span>
						</td>
						<td class="rank">
	...
	<div ng-if="currentPlayer.data.isKing || currentPlayer.data.kingdomRole == Player.KINGDOM_ROLE_DUKE" ng-show="!dataLoading" class="transform contentBox gradient">
		...
		<div class="contentBoxBody">
			...
			<div class="floatWrapper" ng-show="maxSlotsReached">
				<div class="activateInfo" ng-if="currentPlayer.data.isKing || currentPlayer.data.kingdomRole == Player.KINGDOM_ROLE_DUKE">
...
<script type="text/ng-template" id="tpl/building/hideout/hideout_main.html"><div class="buildingDetails">
	<div ng-include src="'tpl/building/partials/buildingInformationEffects.html'"></div>
	<div class="buildingEffect allInVillage contentBox gradient" ng-controller="crannyCtrl">
		...
		<div class="contentBoxBody">
			...
			<div class="lootableResources">
				...
				<div class="resourceWrapper">
					<div class="resource" ng-repeat="(key, resource) in lootableResources" ng-if="!config.balancing.specialRules.cropDiet || key != 4">
...
<script type="text/ng-template" id="tpl/building/mainBuilding/mainBuilding_main.html"><div class="buildingDetails mainBuilding" ng-controller="mainBuildingCtrl">
	...
	<div class="demolish contentBox gradient">
		<h6 class="contentBoxHeader headerWithIcon arrowDirectionDown">
			<i ng-if="!isRubble" class="action_demolish_medium_flat_black"></i>
...
<script type="text/ng-template" id="tpl/building/marketplace/partials/merchantsHeader.html"><div class="headerWithIcon arrowDirectionTo contentBoxHeader">
	...
	<div class="marketplaceHeaderGroup">
		...
		<div class="circle"><span>{{merchants.data.merchantsFree - requiredMerchants}}</span></div>
	</div>
	<div class="marketplaceHeaderGroup">
		...
		<tr ng-repeat="(resourceType, resName) in resNames">
			...
			<td class="sliderCol">
				...
				<div class="lockButtonContainer"
					 ng-class="{open: !resourceData[resourceType]['locked'], disabled: !resourceData[resourceType]['locked'] && lockedResources > availableResTypes - 3}"
	...
	<div class="filterWrapper contentBox">
		...
		<div class="createOffer contentBoxBody">
			...
			<div class="parameters">
				...
				<div class="allyOnly wrapper" ng-show="player.data.kingdomId > 0 && ((currentServerTime-player.data.spawnedOnMap)/86400) >= 7">
					<input type="checkbox" id="limitKingdom" ng-model="newOffer.limitKingdom" />
					<label for="limitKingdom">
						<span translate>Marketplace.Sell.LimitKingdom</span>
					</label>
				</div>
		...
		<div pagination items-per-page="itemsPerPage"
			...
			<thead>
				...
				<tr>
					...
					<td>
						<span translate ng-show="offer.data.limitKingdom">Yes</span>
						<span translate ng-show="!offer.data.limitKingdom">No</span>
					</td>
					<td>
					...
					<tr>
						<td>
							<serverautocomplete
								...
								input-autofocus="true"></serverautocomplete>
							<div ng-show="targetPlayer !== null && targetInput !== null && targetInput != '' && !editTradeRoute">
								<span translate>Player</span>
								:
								<span player-link playerId="{{targetPlayer.data.playerId}}" playerName="{{targetPlayer.data.name}}"></span>
							</div>
						</td>
					...
					<tr>
						<td colspan="3">
							<div class="error" ng-show="noResourceSendToOthers()">
								<i class="symbol_warning_tiny_flat_red"></i>
								<span translate>Marketplace.Send.Overlay.NoResourceSendToOthers</span>
							</div>
...
<script type="text/ng-template" id="tpl/building/partials/displayResources.html"><div class="costs max{{Math.max((resources[0]+'').length,(resources[1]+'').length,(resources[2]+'').length,(resources[3]+'').length)}}digits">
	<span ng-if="!checkStorage">
		<span ng-repeat="(index, type) in resTypes" class="resource {{::type}}Value" ng-if="resourceVisibility[index]" ng-class="{notEnough: !enoughResources(index), enough: enoughResources(index) && colorPositive}" tooltip tooltip-translate="Resource_{{::index}}">
			...
			<span class="production" ng-if="productionPerHour[index] || productionPerHour[index] == 0" translate data="value: {{productionPerHour[index]}}">PerHour</span>
		</span>
	</span>
	<span ng-if="checkStorage">
	...
	<span class="resource consumptionValue" ng-if="consumption || consumption == 0" tooltip tooltip-translate="Resource.CropConsumption">
        <i class="unit_consumption_{{::imageSize}}_flat_black"></i>{{consumption | bidiNumber:'':true:true}}
    </span>
	<span class="resource populationValue" ng-if="population || population == 0" tooltip tooltip-translate="Resource.Population">
        <i class="unit_population_{{::imageSize}}_illu"></i>{{population | bidiNumber:'':true:true}}
    </span>

	<span class="resource treasureValue" ng-if="treasures || treasures == 0" tooltip tooltip-translate="Resource.Treasures">
	...
	<span class="resource timeValue" ng-if="time || time == 0" tooltip tooltip-translate="Duration">
			...
			<table class="transparent">
				<tbody>
					<tr>
						...
						<td>
							<i class="reportIcon reportTypes_reportIcon{{result.successType.attacker}}"></i>
							<span translate>Attacker</span>:
														   {{result.lossPercent.attacker | bidiNumber:"percent"}}
						</td>
						<td>
							<i class="reportIcon reportTypes_reportIcon{{result.successType.defender}}"></i>
							...
							<tr class="farmListEntry" ng-class="{disabled: !farmlist.data.isDefault && !player.hasPlusAccount()}">
								...
								<td clickable="(farmlist.data.isDefault || player.hasPlusAccount()) ? openList({{farmlist.data.listId}},{{$index}}) : null">
									...
									<div class="attackCounter">
										<i class="movement_attack_small_flat_gray" ng-if="!farmlist.data.underAttack" tooltip tooltip-translate="FarmList.NoAttack"></i>
										<i class="reportIcon reportTypes_reportIcon115_pending" ng-if="farmlist.data.underAttack && farmlist.data.underAttack < farmlist.data.villageIds.length"
					...
					<table class="farmListDetailsTable lined fixedTableHeader" scrollable height-dependency="max">
						...
						<tbody>
							<tr ng-repeat="farm in currentFarmListEntries.data">
								...
								<td class="combat">
									<i class="movement_attack_small_flat_gray" ng-if="!farm.data.underAttack" tooltip tooltip-translate="FarmList.NoAttack"></i>
									<i class="reportIcon reportTypes_reportIcon3_flat" ng-if="farm.data.underAttack" tooltip tooltip-translate="FarmList.UnderAttack"
								...
								<td>
									<i ng-if="farm.data.lastReport.notificationType" class="reportIcon reportTypes_reportIcon{{farm.data.lastReport.notificationType}}_flat"
	...
	<div class="contentBoxBody">
		...
		<div class="floatWrapper">
			...
			<div class="contentBox victoryPoints">
				...
				<div class="contentBoxBody">
					<div ng-if="!isInKingdom" class="noKingdom productionPerDay" translate>Treasury.KingdomNeeded</div>
					<div ng-if="isInKingdom" class="productionPerDay" data="production: {{homeProductionPerDay}}" translate>Treasury.VictoryPointsPerHour</div>
				</div>
			</div>
		</div>
...
<div class="transform contentBox gradient">
	...
	<div class="contentBoxBody">
		<div class="floatWrapper">
			...
			<div class="activateControl">
				<button clickable="transformToHiddenTreasury()" ng-show="!transformationFinished">
					<span translate>Treasury.TransformButton.Deactivate</span>
				</button>
			</div>
		</div>
			...
			<div class="contentBox gradient rank bonus">
				<div class="contentBoxBody">
					<span>
						...
						<span tooltip tooltip-translate="WorldWonder.RankingTooltip">
							<i class="chaplet" ng-class="{
								endOfWorld_chapletGold_illu: worldWonder.rank == 1,
								endOfWorld_chapletSilver_large_illu: worldWonder.rank == 2,
								endOfWorld_chapletBronze_large_illu: worldWonder.rank == 3,
								endOfWorld_chapletGreen_large_illu: worldWonder.rank > 3}"></i>
							{{worldWonder.rank}}
						</span>
					</span>
					<span>
				...
				<div class="contentBoxBody">
					<div ng-repeat="contributor in contributors.troops" class="troopsDetailContainer">
						<div class="troopsDetailHeader">
							{{$index|rank}}.
							<span player-link playerId="{{contributor.playerId}}" playerName="{{contributor.playerName}}"></span>
						</div>
				...
				<div class="chatNameContainer" clickable="openChat(chatInfo.data.roomId)">
					<div class="chatName">
						<chat-room-name room-name="chatInfo.data.chatUser.data.name"
										kingdom-role="chatInfo.data.chatUser.data.kingdomRole"
...
<script type="text/ng-template" id="tpl/chat/chatMenu.html"><div class="chatMenu" ng-controller="chatMenuCtrl">
	...
	<div class="chatRoomHeader">
		...
		<div ng-if="room.chatRoom.getRoomType() === ChatRoom.TYPE_KINGDOM">
			<span ng-if="room.chatRoom.getRoomName() !== 0"><kingdom-link kingdomId="{{room.chatRoom.getRoomName()}}"></kingdom-link> |</span> <span class="text" translate >Kingdom</span>
		</div>
...
<textarea ng-if="!isBannedFromMessaging && isActivated" row="2" class="chatInput" chat-input send-function="send" room-id="{{roomId}}" dropable="checkDrop(object)" auto-expand="true" min-height="16" max-height="150"></textarea>
</script>
...
<script type="text/ng-template" id="tpl/chat/partials/chatRoomHeader.html"><div class="chatHeader" ng-controller="chatRoomHeaderCtrl" ng-class="{draggableHeader: !chatInfo.data.isDocked}">
	...
	<div class="membership">
		<kingdom-link ng-if="chatInfo.data.chatUser.data.kingdomId !== 0" nolink="true" kingdomId="{{chatInfo.data.chatUser.data.kingdomId}}"></kingdom-link>
	</div>
...
<script type="text/ng-template" id="tpl/chat/partials/chatRoomMember.html"><div class="chatMember" clickable="clickPlayerAvatar({{member.data.playerId}})"
	...
	<chat-online-status class="chatStatus" chat-user="memberForOnlineStatus"></chat-online-status>
...
<div class="inputWrapper">
	...
	<textarea ng-disabled="isIgnored || isBannedFromMessaging || !isActivated || (room.chatRoom.data.joined === 0 && !ChatRoom.isPrivate('{{::room.roomId}}'))" inline-auto-complete autocompletedata="player,village,kingdom,coords,emptyCoords" ng-attr-placeholder="{{inputPlaceholder}}" class="chatInput" chat-input send-function="send" room-id="{{room.roomId}}" dropable="checkDrop(object)" auto-expand="true" min-height="16" max-height="130"></textarea>
</div></script>
...
<script type="text/ng-template" id="tpl/chat/partials/roomNameWithIcon.html"><span ng-if="online == true">
	<online-status text="Kingdom.Role_{{kingdomRole}}"
...
<script type="text/ng-template" id="tpl/coordinates/coordinates.html"><span>
	<a ng-if="hasLink" clickable="openPage('map', 'centerId', '{{link}}_{{currentServerTime}}');">
		<span class="coordinates coordinatesWrapper {{aligned}}" ng-bind-html=" coord | bidiCoordinate:x:y "></span>
	</a>
	<span ng-if="!hasLink" class="coordinates coordinatesWrapper {{aligned}}"  ng-bind-html=" coord | bidiCoordinate:x:y "></span>
</span></script>
<script type="text/ng-template" id="tpl/directive/bbCodeInput.html"><div class="bbCodeInput">
	<div class="codes">
		...
		<div class="autocomplete" ng-show="searchOpened">
			<serverautocomplete autocompletedata="village,player,kingdom,coords,emptyCoords"
...
<script type="text/ng-template" id="tpl/directive/playerProfile.html"><div class="playerProfile">
	<div class="detailsWrapper" ng-class="{king: playerRole == playerModel.KINGDOM_ROLE_KING, duke: playerRole == playerModel.KINGDOM_ROLE_DUKE}">
		<div class="contentBox gradient">
			<div class="flagHanger" ng-if="!kingdomProfile" ng-class="{king: playerRole == playerModel.KINGDOM_ROLE_KING, duke: playerRole == playerModel.KINGDOM_ROLE_DUKE}">
				<div class="flag"></div>
			...
			<div class="contentBoxHeader headerWithArrowEndings" ng-class="{golden: playerRole == playerModel.KINGDOM_ROLE_KING, goldenEnding: playerRole == playerModel.KINGDOM_ROLE_DUKE}">
				<div class="content" ng-if="!kingdomProfile">{{playerData.name}}</div>
				<div class="content" ng-if="kingdomProfile">{{kingdomProfile}}</div>
			</div>
			<div class="contentBoxBody">
				<div class="playerDetails">
					<div class="contentBox transparent">
						<div class="contentBoxHeader">
							<div ng-if="!kingdomProfile" translate options="{{playerRole}}">Player.Role_?</div>
							<div ng-if="kingdomProfile">
								<i class="community_kingdom_small_flat_black"></i>
								<span player-link playerId="{{playerData.playerId}}" playerName="{{playerData.name}}"></span>
							</div>
						...
						<div class="contentBoxBody">
							...
							<div ng-if="!kingdomProfile">
								<span class="desc" translate>TableHeader.Kingdom</span>
									<span class="data">
										<span ng-if="playerData.kingdomId == 0">-</span>
										<kingdom-link ng-if="playerData.kingdomId > 0" kingdomId="{{playerData.kingdomId}}"></kingdom-link>
									</span>
							</div>
							<div>
					...
					<div class="contentBox transparent">
						...
						<div class="contentBoxBody" ng-if="playerData.kingdomId > 0">
							<div ng-if="playerData.isKing!=true">
								...
								<span class="data"><span player-link playerId="{{playerData.kingId}}" playerName=""></span></span>
							</div>
							<div>
								<span class="desc" translate>Kingdom.Profile.Rank</span>
								<span class="data" ng-if="kingdomStats.rank >= 0">{{kingdomStats.rank|rank}}</span>
								<span class="data" ng-if="kingdomStats.rank === false">-</span>
							</div>
							<div>
								<span class="desc" translate>Kingdom.Profile.Victorypoints</span>
								<span class="data" ng-if="kingdomStats.victoryPoints > 0">{{kingdomStats.victoryPoints|number:0}}</span>
								<span class="data" ng-if="kingdomStats.victoryPoints === false">0</span>
							</div>
							<div>
								<span class="desc" translate>Kingdom.Information.TreasureCount</span>
								<span class="data" ng-if="kingdomStats.treasures">{{kingdomStats.treasures|number:0}}</span>
								<span class="data" ng-if="!kingdomStats.treasures">0</span>
							</div>
							<div>
								<span class="desc" translate>Kingdom.Profile.Members</span>
								<span class="data">{{kingdomStats.members || 0}}</span>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="kingdomWorldWonder" ng-if="kingdomProfile && kingdomStats && kingdomStats.worldWonderLvl !== false">
		<i class="feature_worldWonder_medium_flat_black"></i>
		<span class="wwLabel" translate>Kingdom.Profile.WorldWonder</span>
		<span village-link villageId="{{kingdomStats.worldWonderVillageId}}"></span>
		<span class="level" translate data="level: {{kingdomStats.worldWonderLvl}}, maxLevel: {{config.balancing.endWorldWithWorldWonderLevel}}">Kingdom.Profile.WorldWonder.Level</span>
		<div progressbar class="worldWonderBar" type="green" perc='{{kingdomStats.worldWonderLvl / config.balancing.endWorldWithWorldWonderLevel * 100}}'></div>
	</div>
</div></script>
<script type="text/ng-template" id="tpl/directive/playerRank.html"><tr>
	<td class="rankColumn" ng-if="rank >= 0">{{rank | rank}}</td>
	<td class="rankColumn" ng-if="!rank && rank != 0">-</td>
	<td class="playerColumn" ng-if="playerId">
		<avatar-image class="avatarImage" player-id="{{playerId}}" scale="0.5" avatar-class="profileImage"></avatar-image>
		<chat-online-status ng-if="chatUser" chat-user="chatUser"></chat-online-status>
		<span player-link playerId="{{playerId}}" playerName="{{playerName}}"></span>
		<div class="prestigeStars">
			<prestige-stars playerId="{{playerId}}" size="tiny"></prestige-stars>
		</div>
	</td>
	<td class="pointsColumn" ng-if="playerId">{{points || 0}}</td>

	<td ng-if="!playerId" colspan="2">-</td>
</tr></script>
<script type="text/ng-template" id="tpl/directive/playerVillage.html"><td class="playerColumn">
	<avatar-image class="avatarImage" player-id="{{village.data.playerId}}" scale="0.5" avatar-class="profileImage"></avatar-image>
	<span village-link villageId="{{village.data.villageId}}" villageName="{{village.data.name}}"></span>
	<div ng-if="showMeta">
		<chat-online-status ng-if="chatUser" chat-user="chatUser"></chat-online-status>
		<div class="villageDetails">
			<i class="unit_population_small_flat_black ng-scope"></i>{{village.data.population}}
			<i class="unit_distance_small_flat_black"></i>{{distance | number:0}}
		</div>
	</div>
</td></script>
...
<script type="text/ng-template" id="tpl/directive/villageTribute.html"><div>
	<div ng-if="village.data.allowTributeCollection" class="collectTributesContainer">
		<div class="tributeBar" ng-style="{opacity: (troopMovement.time > currentServerTime && !animation.collect) ? 0 : 1}"
			 tooltip
			 tooltip-class="tributesProductionTooltip"
			 tooltip-url="tpl/society/partials/kingdom/tributes/tributesProductionTooltip.html">
			<div progressbar type="green"
						 perc="{{village.data.tributePercentage}}"
						 marker="{{village.data.tributeTreasureMarker}}"
						 steps="{{village.data.estimatedWarehouseLevel}}"
						 value-interpolation="{{!settings.data.disableAnimations}}"
						 interpolation-threshold="{{village.data.tributesRequiredToFetch / village.data.tributesCapacity}}"
						 interpolation-duration="0.4"
						 interpolation-curve="ease-in"
						 on-interpolation-end="animation.collect = false"></div>
			<i ng-if="village.data.tributeTreasures > 0" class="unit_treasure_small_illu"></i>
		</div>
		<button ng-if="!(troopMovement.time > currentServerTime) || animation.collect"
				ng-class="{disabled: !village.data.canFetchTributes, npcVillageButton: village.data.villageId < 0}"
				clickable="fetchTribute(village.data.villageId);"
				tooltip
				tooltip-class="tributesTooltip"
				tooltip-url="tpl/society/partials/kingdom/tributes/tributesTooltip.html"
				play-on-click="{{UISound.BUTTON_COLLECT_TRIBUTES}}">
			<span translate>Tribute.FetchSelected</span>
		</button>
		<div ng-if="troopMovement.time > currentServerTime && !animation.collect">
			<div class="tributeOnTheWay" ng-class="{collectNow: animation.collectNow}">
				<i class="unit_resources_small_illu"></i>
				{{troopMovement.resourcesSum}}
				<div class="timer">
					<i class="symbol_clock_small_flat_black"></i>
					<span class="countdown" countdown="{{troopMovement.time}}"></span>
					<div class="ending">
						<div class="colored"></div>
					</div>
				</div>
			...
			<button class="premium"
					ng-class="{disabled: animation.collectNow}"
					tooltip
					tooltip-class="tributesTooltip"
					tooltip-url="tpl/society/partials/kingdom/tributes/tributesTooltip.html"
					premium-feature="{{instantFetchTributePremiumFeatureName}}"
					premium-callback-param="{{village.data.villageId}}"
					clickable="showCollectNowAnimation()">
				<span translate>Tribute.FetchInstant</span>
			</button>
		</div>
	</div>
	<div ng-if="!village.data.allowTributeCollection">
		<span class="error" translate>Kingdom.TributeOverview.TributesDenied</span>
		<button disabled class="disabled"><span tooltip tooltip-translate="Kingdom.TributeOverview.TributesDenied.Tooltip" translate>Tribute.FetchSelected</span></button>
	</div>
</div></script>
...
<script type="text/ng-template" id="tpl/directive/generalElements/prestigeStars.html"><div class="innerStars">
	<div ng-if="!badge">
		<i class="prestigeStar prestige_star{{star[0]}}_{{size}}_illu"></i>
		<i class="prestigeStar prestige_star{{star[1]}}_{{size}}_illu"></i>
		<i class="prestigeStar prestige_star{{star[2]}}_{{size}}_illu"></i>
	</div>
	<i ng-if="badge" class="prestigeBadge prestige_{{badgeType}}_{{size}}_illu"></i>
</div></script>
<script type="text/ng-template" id="tpl/directive/generalElements/progressbar.html"><div class="progressbar">
	...
	<div class="progress">
		<div ng-if="steps" class="stepContainer">
			<div class="progressbarStep"
				 ng-repeat="n in [] | range:0:steps"
				 ng-style="{width: (n/steps*100) + '%'}"></div>
		</div>
		<div class="bar positive perc {{type}}"></div>
		<div class="bar additionalBar additionalPerc"></div>
		<div class="marker"><div class="markerInner"></div></div>
...
<script type="text/ng-template" id="tpl/directive/kingdom/kingdomInvitationList.html"><div class="clickableContainer invitationSummary"
	 ng-repeat="invitation in invitations.data"
	...
	<div class="subject" ng-if="invitation.data.invitedAs==Player.KINGDOM_ROLE_GOVERNOR">
		<span translate class="header">Society.Invitation.ToSociety</span>
		<br>
...
<div class="auctionConfirmSelling" ng-if="isNpcBuying">
	<hero-item-container class="heroItemContainer" item="item" hide-amount="true" hide-item-states="true"></hero-item-container>
	<div class="priceCalculation">
		<div class="heroItemName" translate options="{{item.data.itemType}}">Hero.Item_?</div>
		<div class="avgMarketPrice">
			<span translate>Auction.AverageMarketPrice</span>
			<span class="priceAmount">{{prices.avgMarketPrice}}</span>
		</div>
		<div ng-if="tier > 0">
			<span translate data="multiplier:{{(strengthFactor / 100)}}" options="{{strengthFactor}}">Auction.Quality_?</span>
			<span class="priceAmount">{{prices.priceWithStrengthFactor}}</span>
		</div>
		<div>
			<span ng-if="owners == 0" translate data="multiplier:{{ownerMultiplier}}">Auction.OwnersNew</span>
			<span ng-if="owners > 0" translate data="multiplier:{{ownerMultiplier}}, owners: {{owners}}">Auction.Owners</span>
			<span class="priceAmount">{{prices.priceWithOwnerFactor}}</span>
		</div>
		<div ng-if="amount > 1">
			<span translate data="multiplier: {{amount}}">Auction.CalcAmount</span>
			<span class="priceAmount">{{prices.totalPrice}}</span>
		</div>
		<div class="totalPrice">
			<span translate>Auction.SellingPrice</span>
			<span class="priceAmount"><i class="unit_silver_small_illu"></i> {{prices.totalPrice}}</span>
		</div>
	</div>
</div>
...
<script type="text/ng-template" id="tpl/hero/overlay/sellStolenGoods.html"><div class="sellStolenGoods">
	...
	<div class="contentBoxRow">
		...
		<div class="contentBox king">
			<div class="contentBoxBody">
				<avatar-image ng-if="buyer" class="kingAvatar" scale="1" player-id="{{buyer.data.playerId > 100 ? buyer.data.playerId : robber}}"></avatar-image>
			</div>
			<div class="contentBoxFooter">
				<i class="community_{{buyer.isDuke()? 'duke' : 'king'}}_small_flat_black"></i>
				<span player-link playerId="{{buyer.data.playerId}}" playerName="" ng-if="buyer.data.playerId > 100"></span>
				<a class="playerLink truncated disabled" ng-if="buyer.data.playerId < 100"  translate>BanditChief</a>
			</div>
		</div>
	</div>
	<div class="arrow"></div>
	<div class="contentBox treasuresChoice">
		...
		<div class="contentBoxBody">
			<div class="floatWrapper costs">
				...
				<div class="resourceBig">
					<div class="resourceWrapper">
						<div class="cropWarning" ng-if="village.data.belongsToKing != player.data.kingId || buyer.data.playerId < 100">
									...
									<div class="contentBoxBody heroImageContainer">
										...
										<div ng-if="hero.health > 0" class="currentLocation"
											...
											<div ng-if="hero.status != HeroModel.STATUS_IDLE" class="heroStatusContainer">
												<div><i class="heroStatus hero_heroStatus{{hero.status}}_small_illu"></i></div>
					...
					<td class="priceInputCol">
						<input class="priceInput"
							   ...
							   ng-class="{highestBidder: auction.data.highestBidderPlayerId == player.data.playerId,
								...
								ng-disabled="auction.data.highestBidderPlayerId != player.data.playerId && player.data.silver < auction.data.price">
					</td>
					<td class="bidButtonCol">
						<button clickable="placeBid({{auction.data.id}})"
								play-on-click="{{UISound.BUTTON_BET_ON_ITEM}}" ng-class="{disabled: auction.data.highestBidderPlayerId != player.data.playerId && player.data.silver < auction.data.price}"
								tooltip tooltip-translate-switch="{'Error.NotEnoughSilver': {{auction.data.highestBidderPlayerId != player.data.playerId && player.data.silver < auction.data.price}}}">
		...
		<div class="column silverToGold">
			...
			<div class="columnContent">
				...
				<slider class="exchangeSlider"
						...
						slider-lock="exchangeSilver.getRate() > exchangeSilver.getMaxAmount()"
	...
	<table class="silverBookkeeping fixedTableHeader" scrollable height-dependency="max">
		...
		<tr class="highlightRow">
			...
			<td class="silverBlockedDescription description">
				...
				<span clickable="switchShowBlockedSilver()"
					...
					<a ng-if="!showBlockedSilver" ng-hide="silverBlockingAuctions.data.length == 0" translate>Auction.ShowMore</a>
					<a ng-if="showBlockedSilver" ng-hide="silverBlockingAuctions.data.length == 0" translate>Auction.ShowLess</a>
				</span>
			</td>
		...
		<tr ng-repeat="event in silverEvents.data | orderBy:['-data.time','-data.id']">
			...
			<td class="description">
				...
				<div ng-if="event.data.operationType == 5">
					<span translate>Auction.SilverFromCoopPackage</span>
				</div>
				<div ng-if="event.data.operationType == 6">
					<span translate>Auction.SilverFromQuest</span>
				</div>
				<div ng-if="event.data.operationType == 7">
					<span translate>Auction.SilverFromStarterPackage</span>
				</div>
			</td>
...
<script type="text/ng-template" id="tpl/igm/igm.html"><div ng-controller="igmSystemCtrl" class="igmSystem">
		...
		<div class="history" scrollable ng-click="setChatInputState(0)">
			<ul>
				...
				<li ng-repeat-end class="igmConversationEntry" clickable="openConversation(inboxEntry)"
					...
					ng-class="{selected: selectedConversation.data.roomId == inboxEntry.data.roomId,
							   new: inboxEntry.data.ownUnread,
							   closed: inboxEntry.data.closed}">
				</li>
				<div class="divider">
	...
	<div class="threadView" ng-class="{filled: selectedConversation != null, closed: selectedConversation != null && selectedConversation.data.closed}">
		...
		<div class="conversationHeader" ng-class="{selected: selectedConversation != null}">
			<div class="arrow"></div>
			<div class="conversationHeaderInner selectConversation" ng-if="selectedConversation == null">
				<div class="title truncated" translate>Chat.Conversation.Title</div>
			</div>
			<div class="conversationHeaderInner" ng-if="selectedConversation != null && !selectedConversation.data.closed">
				<div class="title truncated" translate data="name:{{selectedConversation.data.roomViewName}}" options="{{selectedConversation.data.roomType}}">Chat.Conversation.With_?</div>
			...
			<div class="conversationHeaderInner" ng-if="selectedConversation != null && selectedConversation.data.closed" ng-class="{cantClose: selectedConversation.data.linePlayerId !== playerId && !isKing}">
				<div class="title" translate data="playerName:{{closedByPlayer}}">Chat.Conversation.Closed</div>
				<div class="menu" ng-if="selectedConversation.data.linePlayerId == playerId || isKing">
					<div class="iconButton" clickable="unCloseConversation('{{selectedConversation.data.roomId}}')" tooltip tooltip-translate="Button.Chat.Open">
						<i class="symbol_lock_small_flat_black"></i>
					</div>
				</div>
			</div>
		...
		<div ng-if="selectedConversation != null && !selectedConversation.data.closed && !selectedConversation.isAdminMessage()"
			...
			<div ng-if="selectedConversation != null && chatInputState == 0" clickable="setChatInputState(1)">
				<i class="chat_insert_message_small_flat writeMessage"></i>
				<div class="inputWrapper">
					<input ng-disabled="isBannedFromMessaging || !isActivated || isIgnored" type="text" placeholder="{{answerPlaceholder}}" ng-model="input.textToSend">
				</div>
			</div>
		</div>
		<div class="writeArea" ng-if="selectedConversation != null && !selectedConversation.data.closed && chatInputState == 1">
			<div class="menu">
			...
			<div class="inputTextAreaWrapper"
				 ...
				 ng-model="input.textToSend" auto-expand="true" min-height="16" max-height="230">
			</div>
			<div class="buttonWrapper">
				<i class="chat_insert_message_small_flat writeMessage"></i>
...
<script type="text/ng-template" id="tpl/igm/igmEntry.html"><div class="igmAvatar">
	...
	<avatar-image scale="0.5" player-id="{{::inboxEntry.data.linePlayerId}}" avatar-class="profile" ng-if="inboxEntry.data.playerId <= 0 && inboxEntry.data.playerId !== -1"></avatar-image>
	<i class="adminIcon igm_admin_small_illu" ng-if="::inboxEntry.data.playerId === -1"></i>
...
<script type="text/ng-template" id="tpl/igm/igmSystemNewConversation.html"><div class="shareReport newIgmConversation">
	<div class="optionContainer">
		...
		<div class="clickableContainer" ng-disabled="user.data.kingdomId == 0"
			 ng-class="{active: shareWith=='kingdom', disabled: user.data.kingdomId == 0}"
...
<script type="text/ng-template" id="tpl/ignorePlayer/ignorePlayer.html"><div class="ignorePlayer" ng-controller="ignorePlayerCtrl">
	<span translate data="playerName:{{playerName}}">Chat.Ignore.Description</span>
	<div class="buttonFooter">
		<button clickable="ignorePlayer()">
			<span translate>Chat.Ignore.WindowName</span>
		</button>
		<button class="cancel" clickable="closeWindow('ignorePlayer');"><span translate>Button.Cancel</span></button>
	</div>
</div></script>
...
<script type="text/ng-template" id="tpl/kingOrGovernor/kingOrGovernor.html"><div ng-controller="kingOrGovernorCtrl" class="contentBody"
	...
	<div class="role {{::role}}" ng-repeat="role in ['governor', 'king']">
		...
		<div class="contentBox">
			...
			<button clickable="selectRole(role)" ng-class="{disabled: role == 'king' && !kingRegistrationOpened}">
				<span translate options="{{::role}}">KingOrGovernor.Confirm_?</span>
			</button>
			<div ng-if="role == 'king' && !kingRegistrationOpened" class="notEnoughPrestigeForKing">
...
<script type="text/ng-template" id="tpl/kingOrGovernor/kingOrGovernorKingTag.html"><div class="contentBox transparent tag">
	<h6 class="contentBoxHeader headerColored" translate>
		Kingdom.NameYourKingdom
	</h6>
...
<script type="text/ng-template" id="tpl/kingdom/kingdom.html"><div ng-controller="kingdomPublicProfileCtrl" class="kingdom">
  	<div ng-include src="'tpl/society/partials/kingdom/Profile.html'"></div>
</div></script>
...
<script type="text/ng-template" id="tpl/mainlayout/contextMenu.html"><div id="contextMenu" ng-controller="contextMenuCtrl" ng-style="contextStyle" ng-class="contextMenuClass">
	...
	<div ng-repeat="item in menuItems" class="item {{item.class}} transition">
		<div ng-show="item.class != 'pos0' && item.class != 'pos6'"
			 ...
			 tooltip-data="disableKingdomChangesWithWWLevel: {{item.params.disableKingdomChangesWithWWLevel}}"
		...
		<div ng-repeat="chat in chatNotifications" class="notification  chatNotification" ng-class="chat.class" ng-if="chat.type == 'chatNotification'">
			...
			<div class="firstLine">
				<div class="avatar">
					...
					<i class="adminIcon igm_admin_small_illu" ng-if="::chat.playerId === -1"></i>
				...
				<div class="playerInfos">
					...
					<div>
						<kingdom-link class="kingdomName" kingdomId="{{chat.kingdomId}}" noLink="true"></kingdom-link>
					</div>
				</div>
			</div>
			<div class="horizontalLine"></div>
...
<div class="questCurrentTask" ng-if="activeQuest === 0">
	<div class="background">
		...
		<div class="content">
			<div class="header">
				<div class="inner" translate>QuestHeader_0</div>
			</div>
			<div class="subquests">
				<div class="subquest">
					<span class="inner" translate >QuestStep_0_0</span>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/ng-template" id="tpl/mainlayout/sidebarMenu.html">	<div id="sidebarMenu" class="sidebar unselectable" ng-controller="sidebarMenuCtrl">
	...
	<div class="mainLayoutMenuButton directionDown withArrowTip communityAttacksButton"
		 ...
		 tooltip
		 tooltip-translate="Button.AttacksKingdom"
		 tooltip-placement="after">
		<div class="arrowEnding"></div>
			...
			<div class="content">
				<div class="wrapper">
					<div class="wrapper2">
						...
						<span translate data="kingdomId:{{winnerKingdomId}}">WorldEnded.WinnerKingdom</span>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/ng-template" id="tpl/mainlayout/modals/worldEnd.html"><div class="modal worldEnd {{w.params.modalParams.additionalClass}} {{w.params.modalParams.windowName}} {{windowClass}}" ng-controller="windowCtrl">
	<div class="modalContent" ng-style="{minHeight: w.getOverlayHeightWithPadding(-10) || 'none'}">
		<div class="endOfWorldDecoration  endOfWorld_windowHeader_large_illu contentHeader">
			<h2>
				<span translate options="{{w.windowName}}" data="{{w.windowNameData}}">?</span>
			</h2>
		</div>
	...
	<div ng-show="api.target.villageId > 0">
		...
		<table class="transparent">
			...
			<tr ng-if="api.targetPlayer.data.kingdomId > 0">
				<th translate>TableHeader.Kingdom</th>
				<td>
					<kingdom-link kingdomId="{{api.targetPlayer.data.kingdomId}}"></kingdom-link>
				</td>
			</tr>
...
<script type="text/ng-template" id="tpl/mainlayout/partials/treasureTooltip.html"><div class="kingdomTooltip">
	...
	<table class="transparent">
		...
		<tr ng-if="player.data.kingdomId > 0">
...
<div class="tributeCropContainer">
	<div class="tributes contentBox gradient" ng-show="showTributes">
		<div class="contentBoxBody">
			<display-resources resources="village.tributes" treasures="village.tributeTreasures" hide-zero="true"></display-resources>
			<div class="barView">
			...
			<button clickable="fetchTributes()" ng-class="{disabled: !village.canFetchTributes || !village.allowTributeCollection || !village.protectionGranted || !activeTreasury || (!territoryConnected && village.type != Village.TYPE_GOVERNOR_NPC_VILLAGE)}"
					play-on-click="{{UISound.BUTTON_COLLECT_TRIBUTES}}"
			tooltip tooltip-translate-switch="{'ContextMenu.button.fetchTribute.denied': {{!village.allowTributeCollection}},
											   'ContextMenu.button.fetchTribute.unprotected': {{!village.protectionGranted}},
											   'Tributes.VillageNotGeneratingInfluence': {{!activeTreasury}},
											   'Tributes.VillageNotConnected': {{activeTreasury && (!territoryConnected && village.type != Village.TYPE_GOVERNOR_NPC_VILLAGE)}}}">
...
<div class="contentBoxBody oasisDetails" ng-class="{occupied: !animals}">
	...
	<div ng-if="!animals">
		<div class="owner">
			...
			<kingdom-link ng-if="mapDetails.kingdomId > 0" kingdomId="{{mapDetails.kingdomId}}"></kingdom-link>
		</div>
...
<script type="text/ng-template" id="tpl/markerMenu/tabs/AllMarker.html"><div class="allMarkers">
	<div class="contentBox">
		<div class="contentBoxHeader headerWithIcon arrowDirectionTo">
			<i class="community_kingdom_medium_flat_black"></i>
			<span translate>ContextMenu.MarkerMenu.KingdomMarker</span>
		</div>
		<div class="default-colors clear">
            ...
            <ul>
                ...
                <li ng-if="playerInKingdom"><div class="marker"><div class="markerColor" ng-style="{{defaultColors.confederacies.cssStyle}}"></div></div> <span translate>AllMarker.Confederacies</span></li>
                <li ng-if="playerInKingdom"><div class="marker"><div class="markerColor" ng-style="{{defaultColors.nap.cssStyle}}"></div></div> <span translate>AllMarker.NonAggressionPact</span></li>
                ...
                <li ng-if="playerInKingdom"><div class="marker"><div class="markerColor" ng-style="{{defaultColors.enemies.cssStyle}}"></div></div> <span translate>AllMarker.Enemies</span></li>
            </ul>
        </div>
        <table ng-if="allKingdomMarkers.length > 0" class="contentBoxBody">
			<thead>
				<tr>
					<th translate>Kingdom</th>
			...
			<tbody>
				<tr ng-repeat="marker in allKingdomMarkers">
					<td><kingdom-link kingdomId="{{ marker.targetId }}"></kingdom-link></td>
					<td class="colorCol"><span class="markerColor" ng-style="{{ marker.colorData.cssStyle }}"></span></td>
					<td class="deleteCol">
						<i ng-if="marker.owner == typePlayer || (marker.owner == typeKingdom && hasKingdomRights)"
						   ng-class="{action_delete_small_flat_black: !deleteHover, action_delete_small_flat_red: deleteHover}"
    ...
    <div ng-if="allPlayerMarkers.length == 0 && allKingdomMarkers.length == 0 && allTileMarkers[typePlayer].length == 0 && allTileMarkers[typeKingdom].length == 0">
	        ...
	        <tbody>
	            <tr ng-repeat="marker in allPlayerMarkers">
					...
					<td class="visibleFor">
						...
						<span ng-if="marker.owner == typeKingdom" translate>Kingdom</span>
					</td>
	                <td class="deleteCol">
						<i ng-if="marker.owner == typePlayer || (marker.owner == typeKingdom && hasKingdomRights)"
						   ng-class="{action_delete_small_flat_black: !deleteHover, action_delete_small_flat_red: deleteHover}"
	...
	<div class="contentBox" ng-if="allTileMarkers[typeKingdom].length > 0">
		<div class="contentBoxHeader headerWithIcon arrowDirectionTo">
			<i class="marker_tile_medium_flat_black"></i>
			<span translate>ContextMenu.MarkerMenu.CoordinateMarker.Kingdom</span>
		</div>
		<table class="contentBoxBody">
			<thead>
				<tr>
			...
			<tbody>
				<tr ng-repeat="marker in allTileMarkers[typeKingdom]">
					<th class="coordinates"><div coordinates aligned="false" x="{{marker.x}}" y="{{marker.y}}"></div></th>
					<td class="colorCol"><span class="markerColor" ng-style="{{ marker.colorData.cssStyle }}"></span></td>
					<td class="deleteCol">
						<i ng-if="marker.owner == typePlayer || (marker.owner == typeKingdom && hasKingdomRights)"
...
<script type="text/ng-template" id="tpl/markerMenu/tabs/EditMarker.html"><div class="newMarker">
	...
	<div class="markerWrapper">
		<div ng-repeat="type in [3,1,2]"
			...
			<div class="horizontalLine"></div>
			<!-- Override when there is an kingdom marker and I don't have rights to change it -->
			<div ng-if="typeTable[type].owner == typeKingdom && !hasKingdomRights" class="typeSelector contentBoxBody">
				<div class="colors" ng-if="typeTable[type].show" tooltip tooltip-translate="ContextMenu.MarkerMenu.KingdomNoRight">
					<div class="colorButtons">
						<div class="markerColor selected" ng-style="{{ colorByIndex[typeTable[type].color].cssStyle }}"></div>
					</div>
				</div>
			</div>
			<div class="typeSelector contentBoxBody" ng-show="!(typeTable[type].owner == typeKingdom && !hasKingdomRights)"
				...
				<div class="colors" ng-show="typeTable[type].show">
					...
					<label ng-hide="!selectionAvailable(type)" ng-if="hasKingdomRights">
						<input type="checkbox" ng-checked="typeTable[type].owner == typeKingdom" clickable="toggleShareWithKingdom(type)"/>
						<span translate>ContextMenu.MarkerMenu.ShareWithKingdom</span>
					</label>
				</div>
...
<script type="text/ng-template" id="tpl/npcTrader/finishNowTooltip.html"><div class="finishNowTooltip" ng-controller="finishNowCtrl">
	...
	<div ng-if="!isWorldWonder && hasInvalidBuilding && !config.balancing.specialRules.cropDiet" translate>FinishNow.CantInstantComplete</div>
	<div ng-if="!isWorldWonder && hasInvalidBuilding && config.balancing.specialRules.cropDiet" translate>FinishNow.CantInstantComplete.CropDiet</div>
...
<script type="text/ng-template" id="tpl/payment/tabs/PremiumFeatures.html"><div ng-controller="premiumFeaturesCtrl" class="premiumFeatures spendGold">
	<div class="contentBox">
		<div class="contentBoxBody">
			<div class="featureList">
				<div ng-repeat="feature in featureList | orderBy:'order'"
					 ng-show="!feature.isDisabled || feature.active"
					 class="clickableContainer"
					 ng-class="{active: activeFeature.name == feature.name, bookable: feature.canActivate, booked: feature.active}"
					 clickable="changeActiveFeature(feature)">
        ...
        <div class="contentBox">
            ...
            <div class="contentBoxHeader centeredTitle headerColored">
                ...
                <span class="prestigeRankingHeaderRank">
                    <i class="symbol_ranking_small_flat_black" tooltip tooltip-translate="Rank"></i>
                </span>
	...
	<div class="contentBox transparent medals">
		...
		<div class="contentBoxBody" scrollable>
			...
			<div class="achievementWrapper" ng-if="achievements.data.length > 0">
				<achievement-image ng-repeat="achievement in achievements.data" player-id="{{achievement.data.playerId}}" id="{{achievement.data.id}}" clickable="addAchievement({{achievement.data.id}});">
				</achievement-image>
			</div>
		</div>
	</div>
...
<script type="text/ng-template" id="tpl/profile/settings/tabs/Gameplay.html"><div class="contentBox">
	...
	<div class="contentBoxBody">
		<table>
			<tr class="settingsRow"
				ng-repeat="(key, item) in checkboxSettings"
				ng-if="key != 'disableAnimations'"
				tooltip
				tooltip-translate="Settings.SettingTooltip_{{key}}"
				tooltip-show="{{checkboxSettings[key].hasTooltip}}">
	...
	<div class="borderWrapper">
		...
		<div ng-if="isAdventure" class="buttonWrapper">
			...
			<div ng-if="hero.data.status != 0">
				<i class="heroStatus hero_heroStatus{{hero.data.status}}_small_illu"></i>
...
<script type="text/ng-template" id="tpl/relocation/partials/header.html"><div class="contentHeader">
	<div>
		...
		<div class="relocationHeader">
			...
			<a clickable="openWindow('help', {'pageId': 'Village_Relocation'})"><span translate>InGameHelp.ReadMore</span></a>
		</div>
	</div>
</div></script>
<script type="text/ng-template" id="tpl/report/header.html"><div class="headerBox">
	<div class="reportHeaderBg reportTypes_reportType{{header.notificationType}} success{{header.successType}}"></div>
	<div class="playerBox actionFrom">
		...
		<div class="playerLabel">
			<div class="playerAndKingdom">
				...
				<span ng-if="header.sourceKingdomId && header.sourceKingdomId > 0">({{header.sourceKingdomTag}})</span>
			</div>
			<div class="fromVillage">
				...
				<i class="reportIcon reportTypes_reportIcon{{header.attackerReportType || header.notificationType}}_flat"></i>
			</div>
			<div class="prestigeStars"
		...
		<i class="shareBubble report_shareBubble_medium_illu" ng-if="header.ownRole == 'attacker' && header.shareMessage" tooltip="{{header.shareMessage}}" tooltip-placement="above"></i>
	</div>
	...
	<div class="playerBox actionTo">
		...
		<div ng-if="header.notificationType != Notifications.REPORT_FARMLIST_RAID && header.notificationType != Notifications.REPORT_ADVENTURE" class="playerLabel">
			<div class="playerAndKingdom">
				...
				<span ng-if="header.destKingdomId && header.destKingdomId > 0">({{header.destKingdomTag}})</span>
			</div>
			<div class="fromVillage">
				<span translate>Report.From</span>
				<span village-link villageName="{{header.destName}}" villageId="{{header.destId}}"></span>
				<i ng-if="header.defenderReportType" class="defenderReportIcon reportTypes_reportIcon{{header.defenderReportType}}_flat"
		...
		<i class="shareBubble report_shareBubble_medium_illu" ng-if="header.ownRole == 'defender' && header.shareMessage" tooltip="{{header.shareMessage}}" tooltip-placement="above"></i>
	</div>
</div>
...
<script type="text/ng-template" id="tpl/report/report.html"><div class="inWindowPopup singleReport" ng-if="header.time">
	...
	<div class="reportCaption" ng-if="header.successType && header.notificationType != Notifications.REPORT_FARMLIST_RAID">
		<div class="banner result{{header.successType}}">
			<span class="content">
				<i class="reportIcon reportTypes_reportIcon{{header.ownRole ? header[header.ownRole+'ReportType'] : header.notificationType}}_base"></i>
...
<script type="text/ng-template" id="tpl/report/partials/dialogShare.html"><div class="shareReport">
	...
	<div class="directLink contentBox colored" ng-if="shareCode">
		<div class="contentBoxBody">
			...
			<i class="reportIcon reportTypes_reportIcon{{reportType}}_flat draggableReport" draggable="{link: '[report:' + shareCode + ']'}"
...
<script type="text/ng-template" id="tpl/report/types/farmlistReport.html"><div class="troopsScrollContainer">
	...
	<div class="troopsDetailContainer">
		<div class="troopsDetailHeader fromHeader">
			<i class="reportIcon reportTypes_reportIcon{{troopDetails['successType']}}_flat"></i>
			<span translate>Attacker</span>:
				...
				<tr ng-repeat="target in body.targets" ng-class="{highlighted: highlight == target.destVillageId}">
					<td>
						<div ng-if="target.arrivalTime < $root.currentServerTime">
							...
							<i ng-if="target.sumDied > 0 && target.sumDied < target.sumSent" class="reportIcon reportTypes_reportIcon2_flat"></i>
							<i ng-if="target.sumDied >= target.sumSent" class="reportIcon reportTypes_reportIcon3_flat"></i>
						</div>
					</td>
...
<script type="text/ng-template" id="tpl/report/types/fightReport.html"><div class="troopsScrollContainer">
	...
	<div class="troopsDetailContainer" ng-repeat="troopDetails in troopsDataAttacker">
		<div class="troopsDetailHeader fromHeader">
			<i class="reportIcon reportTypes_reportIcon{{troopDetails['successType']}}_flat"
	...
	<div class="troopsDetailContainer" ng-repeat="troopDetails in troopsDataDefender | orderBy:['type', 'tribeId']"
		...
		<div class="troopsDetailHeader toHeader">
			<i class="reportIcon reportTypes_reportIcon{{troopDetails['successType'] + DEFENDER_OFFSET}}_flat" ng-class="{unknown: troopDetails['unknown']}"></i>
	...
	<div class="troopsDetailContainer" ng-repeat="troopDetails in troopsDataSummary">
		<div class="troopsDetailHeader toHeader">
			<i class="reportIcon reportTypes_reportIcon{{troopDetails['successType'] + DEFENDER_OFFSET}}_flat"></i>
...
<script type="text/ng-template" id="tpl/reportConversation/reportConversation.html"><div class="reportConversation" ng-controller="reportConversationCtrl">
	...
	<label ng-show="showIgnorePlayer"><input type="checkbox" ng-model="form.ignore" ng-value="1"><span translate>Chat.Ignore.Checkbox</span></label>
	<span class="error" ng-if="error">{{error}}</span>
	<div class="buttonFooter">
	...
	<div class="reportFilter filterBar">
		<div class="filterGroup" ng-repeat="type in reportFilters track by $index" clickable="w.toggleFilter('{{type}}')">
			<a	class="filter iconButton"
				...
				<i class="reportIcon reportTypes_reportIcon{{type}}"></i>
			</a>
			<div class="subFilter" ng-show="filterActive[type]">
				<a class="filter iconButton" ng-repeat="type2 in reportFilterGroups[type]"
					...
					<i class="reportIcon reportTypes_reportIcon{{type2}}"></i>
				</a>
			</div>
		</div>
	</div>
		...
		<tbody>
			<tr ng-repeat="report in reports track by $index">
				<td class="reportDescription">
					<i class="reportIcon reportTypes_reportIcon{{report.notificationType}}" tooltip tooltip-translate="Notification_{{report.notificationType}}" ng-if="!report.sharedBy && report.displayType!=11 && report.displayType!=12"></i>
					<i class="reportIcon reportTypes_reportIcon0" tooltip tooltip-translate="Notification_{{report.notificationType}}" ng-if="report.sharedBy && report.displayType!=11 && report.displayType!=12"></i>
					<i class="reportIcon reportTypes_reportIcon{{report.outcome}} pending" tooltip tooltip-translate="Notification_115_115" ng-if="report.displayType==11"></i>
					<i class="reportIcon reportTypes_reportIcon{{report.outcome}}" tooltip tooltip-translate="Notification_{{report.outcome}}" tooltip-data="totalAmount: {{report.targetsTotal+'x'}}" ng-if="report.displayType==12"></i>
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/Diplomacy.html"><div ng-controller="kingdomDiplomacyCtrl" class="diplomacy">
	<div class="contentWrapper" scrollable height-dependency="max">
		<div class="category">
			<table>
				<thead>
				<tr>
					<th colspan="3" translate>Kingdom.Diplomacy.OpenTreaties</th>
				</tr>
				</thead>
				<tbody>
				<tr ng-repeat="i in kingdom.data.diplomacy.foreignOffers">
					<td>
						<kingdom-link kingdomId="{{i.otherKingdomId}}"></kingdom-link>
					</td>
					<td>
						<span options="{{i.type}}" translate>Kingdom.Diplomacy.ReceivedOffer_?</span>
					</td>
					<td class="buttonContainer">
						<button clickable="acceptTreaty('{{i.id}}')" ng-if="!isSitter">
							<span translate options="{{i.type}}">
								Kingdom.Diplomacy.ReceivedOffer.Button.Accept_?
							</span>
						</button>
						<button class="cancel" clickable="deleteTreaty('{{i.id}}')" ng-if="!isSitter">
							<span translate options="{{i.type}}">
								Kingdom.Diplomacy.ReceivedOffer.Button.Decline_?
							</span>
						</button>
					</td>
				</tr>
				<tr ng-repeat="i in kingdom.data.diplomacy.ownOffers">
					<td>
						<kingdom-link kingdomId="{{i.otherKingdomId}}" kingdomName="{{i.otherKingdomTag}}"></kingdom-link>
					</td>
					<td>
						<span options="{{i.type}}" data="date: {{i.offered}}" translate>Kingdom.Diplomacy.OfferSent_?</span>
					</td>
					<td class="buttonContainer">
						<button class="cancel" clickable="deleteTreaty('{{i.id}}')" ng-if="!isSitter">
							<span translate>Kingdom.Diplomacy.OfferSent.Button.Cancel</span>
						</button>
					</td>
				</tr>
				<tr ng-if="kingdom.data.diplomacy.ownOffers.length == 0 && kingdom.data.diplomacy.foreignOffers.length == 0">
					<td colspan="3" translate>Kingdom.Diplomacy.NoDiplomacyOffers</td>
				</tr>
				</tbody>
			</table>
		</div>
		<div class="category">
			<table>
				<thead>
				<tr>
					<th colspan="2" translate>Kingdom.Diplomacy.BNDs</th>
				</tr>
				</thead>
				<tbody>
				<tr ng-repeat="i in treaties[TYPE.BND]">
					...
					<td class="buttonContainer">
						<button class="cancel" clickable="cancelTreaty('{{i.id}}')" ng-if="!isSitter">
							<span translate>Kingdom.Diplomacy.Treaty.Button.Cancel</span>
						</button>
					</td>
				</tr>
				<tr ng-if="treaties[TYPE.BND] == 0">
					<td colspan="2" translate>Kingdom.Diplomacy.NoBND</td>
				</tr>
				</tbody>
			</table>
		</div>
		<div class="category">
			<table>
				<thead>
				<tr>
					<th colspan="2" translate>Kingdom.Diplomacy.NAPs</th>
				</tr>
				</thead>
				<tbody>
				...
				<tr ng-if="treaties[TYPE.NAP] == 0">
					<td colspan="2" translate>Kingdom.Diplomacy.NoNAP</td>
				</tr>
				</tbody>
			</table>
		</div>
		<div class="category">
			<table>
				<thead>
				<tr>
					<th colspan="2" translate>Kingdom.Diplomacy.Wars</th>
				</tr>
				</thead>
				<tbody>
				...
				<tr ng-if="treaties[TYPE.WAR] == 0">
					<td colspan="2" translate>Kingdom.Diplomacy.NoWAR</td>
				</tr>
				</tbody>
			</table>
		</div>
		<div class="buttonFooter">
			...
			<button clickable="openOverlay('kingdomOfferTreaty');" ng-if="!isSitter">
				<span translate>Kingdom.Diplomacy.Button.OfferTreaty</span>
			</button>
			<button class="disabled"
					tooltip
					tooltip-translate="Sitter.DisabledAsSitter"
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/IndependentGovernor.html"><div ng-controller="kingdomIndependentGovernorCtrl" class="noKingdom">
	<div class="contentBox invitations" ng-if="invitations.data.length > 0">
		<h6 class="contentBoxHeader headerWithArrowEndings glorious">
			<div class="content" translate>Kingdom.Header.Invitations</div>
		</h6>
		<div class="contentBoxBody">
	...
	<div class="contentBox kingdomExplanation">
		<h6 class="contentBoxHeader headerWithArrowEndings glorious">
			<div class="content" translate>Kingdom.Header.Explanation</div>
		</h6>
		<div class="contentBoxBody">
			<i class="community_kingdom_huge_illu"></i>
			<p class="description" translate>Kingdom.Description</p>
		</div>
	</div>

	<div class="contentBox nearestKings">
		<h6 class="contentBoxHeader headerWithArrowEndings glorious">
			<div class="content" translate>Kingdom.Header.NearKings</div>
		</h6>
		<div class="contentBoxBody">
			<span translate>Kingdom.NearKings.Description</span>
		</div>
		<table class="nearestKings">
			<thead>
				<tr>
					<th colspan="2">
						<span translate>Kingdom.NearKings.Header.Kings</span>
					</th>
					<th>
						<i class="unit_distance_small_flat_black" tooltip tooltip-translate="Kingdom.NearKings.Distance"></i>
					</th>
					<th>
						<i class="community_governor_small_flat_black" tooltip tooltip-translate="Kingdom.NearKings.Governor"></i>
					</th>
					<th></th>
				</tr>
			</thead>
			<tbody>
				<tr ng-repeat="king in nearestKings">
					<td class="kingAvatar">
						<avatar-image class="avatarImage" player-id="{{king.playerId}}" scale="0.5" avatar-class="profileImage"></avatar-image>
					</td>
					<td class="kingInfo">
						<span player-link playerId="{{king.playerId}}"></span>
						<br/>
						<div class="kingColumnPopulation">
							<i class="unit_population_small_flat_black"></i>
							<span>{{king.population}}</span>
						</div>
					</td>
					<td class="kingDistance">{{king.distance | number:1}}</td>
					<td class="kingGovernor">{{king.governorCount}}</td>
					<td class="kingContact">
						<button class="contactKing"
								tooltip tooltip-translate="Chat.Open"
								clickable="openChat(getPrivateRoomName(king.playerId))">
							<span translate>Kingdom.NearKings.Contact</span>
						</button>
						<div class="iconButton centerMapButton"
							 tooltip tooltip-translate="CellDetails.CenterMap"
							 clickable="openPage('map', 'centerId', '{{king.villageId}}_{{currentServerTime}}'); closeWindow(w.name);">
							<i class="symbol_target_small_flat_black"></i>
						</div>
					</td>
				</tr>
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/Intern.html"><div class="intern" ng-controller="kingdomInternCtrl">
	<div class="statistics contentBox gradient">
		<h6 class="contentBoxHeader headerWithArrowEndings glorious">
			<div class="content" translate>Kingdom.Intern.Statistics</div>
		</h6>
		<div class="contentBoxBody">
			<div class="statsBox attack contentBox colored contentBoxBody"
				 tooltip
				 tooltip-translate="Kingdom.Intern.AttackPower">
				<i class="kingdom_totalOffense_medium_illu"></i>
				<div class="absoluteValue lastDay">{{offStrength.lastDay|number:0}}</div>
				<div class="rankValue" translate data="rank:{{offRank|rank}}">Kingdom.Intern.StrengthRank</div>
			</div>
			<div class="statsBox defense contentBox colored contentBoxBody"
				 tooltip
				 tooltip-translate="Kingdom.Intern.DefensePower">
				<i class="kingdom_totalDefense_medium_illu"></i>
				<div class="absoluteValue lastDay">{{defStrength.lastDay|number:0}}</div>
				<div class="rankValue" translate data="rank:{{defRank|rank}}">Kingdom.Intern.StrengthRank</div>
			</div>
		</div>
	</div>
			...
			<table class="transparent">
				<tbody>
					<tr ng-repeat="i in treaties">
						...
						<td>
							<span options="{{i.type}}" data="victimId: {{i.otherKingdomId}}, victimName: {{i.otherKingdomTag}}" translate>Kingdom.Intern.Diplomacy.Type_?</span>
						</td>
					</tr>
				</tbody>
			</table>
	...
	<div class="internalInfos contentBox colored" ng-class="{'diplomacyBlockShown': treaties.length > 0}">
		<div class="contentBoxHeader">
			<span translate>Kingdom.Intern.InternalInfos</span>
			<i ng-if="player.data.isKing && !isSitter"
			   class="headerButton"
			   ng-class="{action_edit_small_flat_black: !editHover, action_edit_small_flat_green: editHover}"
			   on-pointer-over="editHover = true" on-pointer-out="editHover = false"
			   clickable="openOverlay('kingdomEditInternalInfo');"></i>
		</div>
	...
	<div class="newsFeed contentBox gradient">
		<h6 class="contentBoxHeader headerWithArrowEndings glorious">
			<div class="content" translate>Kingdom.Intern.NewsFeed</div>
		</h6>
		<div class="contentBoxBody">
			<div pagination items-per-page="itemsPerPage"
						number-of-items="numberOfItems"
				...
				<table class="columnOnly">
					<tr ng-repeat="n in news">
						<td>
							<span options="{{n.type}}" data="agentId: {{n.agentId}}, agentName: {{n.agentName}}, victimId: {{n.victimId}}, victimName: {{n.victimName}}" translate>Kingdom.News.Type_?</span>
						</td>
						<td>
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/Profile.html"><div ng-controller="kingdomProfileCtrl" class="profile">
	<div class="innerProfile" scrollable>
		<div class="kingProfile">
			<player-profile playerId="{{king.data.playerId}}" kingdomProfile="{{kingdom.data.tag}}"></player-profile>
			<chat-online-status class="kingStatus" chat-user="kingdom.getKing().chatUser"></chat-online-status>
			<div class="changeTag" ng-if="player.data.isKing && !isSitter && player.data.kingdomId == kingdom.data.groupId">
				<i class="headerButton"
				   ng-class="{action_edit_small_flat_black: !editHover, action_edit_small_flat_green: editHover}"
				   on-pointer-over="editHover = true" on-pointer-out="editHover = false"
				   clickable="openOverlay('kingdomChangeTag')"
				   tooltip tooltip-translate="Button.Edit"></i>
			</div>
		</div>
		<div class="contentBox dukeSlots" ng-if="dukeSlots.length > 0" ng-class="{'myKingdom': myKingdom}">
			<div class="contentBoxHeader headerWithArrowEndings purple">
				<div class="content" translate>Kingdom.Profile.Dukes</div>
			</div>
			<div class="contentBoxBody clear">
				<div ng-repeat="slot in dukeSlots track by $index" class="dukeSlot">
					<h6 class="headerTrapezoidal dukeName">
						<div class="content" ng-if="slot.duke">
							<span class="truncated">{{slot.duke.name}}</span>
						</div>
						<div class="content" ng-if="!slot.duke">
							<span class="truncated" translate options="{{slot.type}}">Kingdom.Profile.Slot.?</span>
						</div>
					</h6>
					<div class="playerProfileAvatar small {{slot.type}}" ng-click="dukeAction(slot)" on-pointer-over="dukeHover = true" on-pointer-out="dukeHover = false"
						 tooltip tooltip-translate-switch="{'Kingdom.Dukes.Slots.Tooltip.cancelInvitation': {{slot.type == 'invitation' && myKingdom}},
															'Kingdom.Dukes.Slots.Tooltip.PromoteDuke.Description': {{slot.type == 'available' && myKingdom}},
															'Kingdom.Profile.Slot.Unlock': {{slot.type == 'locked' && myKingdom}}}" tooltip-data="number: {{$index + 1}}">
						<div ng-if="slot.type == 'active'">
							<div ng-if="myKingdom || slot.duke.playerId === player.data.playerId" class="abdicate" clickable="dismissDuke(slot.duke.playerId)"
								 tooltip tooltip-translate-switch="{'Embassy.Communities.Kingdom.abdicateAsDuke': {{slot.duke.playerId === player.data.playerId}},
																	'Kingdom.Dukes.Slots.Tooltip.DismissDuke': {{myKingdom}} }">
								<i class="action_leave_small_flat_red"></i>
							</div>
							<chat-online-status chat-user="slot.duke.chatUser"></chat-online-status>
						</div>
						<div ng-if="slot.type == 'locked'">
							<i class="lockIcon symbol_lock_medium_flat_black"></i>
						</div>
						<div ng-if="slot.type == 'invitation'">
							<i class="symbol_hourglass_small_flat_black"></i>
							<i class="middleIcon action_invite_medium_flat_black"></i>
							<i class="middleIcon action_delete_medium_flat_red"></i>
							<span translate class="textLabel">Button.Cancel</span>
						</div>
						<div ng-if="slot.type == 'available' && myKingdom">
							<span translate class="textLabel">Kingdom.Profile.Slot.Invite</span>
							<i class="middleIcon" ng-class="{action_invite_medium_flat_black: !dukeHover, action_invite_medium_flat_green: dukeHover}"></i>
						</div>

						<div class="avatarLink">
							<avatar-image class="avatarImage" player-id="{{slot.duke.playerId}}" avatar-class="profileImage"></avatar-image>
							<div class="prestigeStars" ng-if="config.balancing.features.prestige">
								<prestige-stars playerId="{{slot.duke.playerId}}" size="tiny"></prestige-stars>
							</div>
						</div>
						<span class="decoration"></span>
					</div>
		...
		<div class="contentBox kingdomGovernors">
			<div class="contentBoxHeader headerWithArrowEndings tableGreen">
				<div class="content" translate>Kingdom.Profile.Governors</div>
			</div>
			<div class="contentBoxBody">
				<div class="governors">
					<table class="gradient">
						...
						<tbody>
							<tr ng-repeat="governor in governors track by $index" player-rank player-id="{{governor.playerId}}" player-name="{{governor.name}}" rank="{{$index}}" points="{{governor.population}}" chat-user="governor.chatUser"></tr>
						</tbody>
					</table>
				</div>
				<div class="contentBox description">
					<div class="contentBoxHeader">
						<span translate>Kingdom.Profile.Description</span>
						<i ng-if="player.data.isKing && !isSitter && player.data.kingdomId == kingdom.data.groupId"
						   class="headerButton"
						   ng-class="{action_edit_small_flat_black: !editHover, action_edit_small_flat_green: editHover}"
						   on-pointer-over="editHover = true" on-pointer-out="editHover = false"
						   clickable="openOverlay('kingdomEditDescription', {'kingdomId': kingdom.data.groupId})"
						   tooltip tooltip-translate="Button.Edit"></i>
					</div>
					<div class="contentBoxBody">
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/Ranking.html"><div class="kingdomRanking" ng-controller="kingdomRankingCtrl">
	<div class="contentWrapper" scrollable height-dependency="max">
		<div class="treasureRank contentBox transparent">
			<h6 class="contentBoxHeader headerWithArrowEndings tableGreen">
				<div class="content" translate>Kingdom.Ranking.Treasure</div>
			</h6>
			<table class="gradient" ng-class="{'inRank': ownTreasureRank && ownTreasureRank.rank < 10}">
				<thead>
					<tr><th colspan="3"><span translate>Kingdom.Ranking.Treasure.Description</span></th></tr>
				</thead>
				<tbody class="ranks">
					<tr ng-repeat="rank in treasuresRanking | limitTo:10" ng-class="{'highlighted': rank.playerId == player.data.playerId}"
						player-rank player-id="{{rank.playerId}}" player-name="{{rank.name}}" rank="{{rank.rank}}" points="{{rank.points}}"></tr>
				</tbody>
				<tbody class="ownRank" ng-if="!ownTreasureRank || ownTreasureRank.rank > 9">
					<tr player-rank player-id="{{player.data.playerId}}" player-name="{{player.data.playerName}}" rank="{{ownTreasureRank.rank}}" points="{{ownTreasureRank.points}}"></tr>
				</tbody>
			</table>
		</div>
		<div class="playerOfTheWeek">
			<div class="contentBox transparent">
				<h6 class="contentBoxHeader headerWithArrowEndings tableGreen">
					<div class="content" translate>Kingdom.Ranking.Attacker</div>
				</h6>
				<table class="gradient" ng-class="{'inRank': ownRanks.top10Attacker && ownRanks.top10Attacker.rank < 3}">
					<thead>
						<tr><th colspan="3">&nbsp;</th></tr>
					</thead>
					<tbody class="ranks">
						<tr ng-repeat="i in [0, 1, 2]" ng-class="{'highlighted': kingdom.stats.top10Attacker[i].playerId == player.data.playerId}"
							player-rank player-id="{{kingdom.stats.top10Attacker[i].playerId}}" player-name="{{kingdom.stats.top10Attacker[i].name}}" rank="{{i}}" points="{{kingdom.stats.top10Attacker[i].points}}"></tr>
					</tbody>
					<tbody class="ownRank" ng-if="!ownRanks.top10Attacker || ownRanks.top10Attacker.rank > 2">
						<tr player-rank player-id="{{player.data.playerId}}" player-name="{{player.data.playerName}}" rank="{{ownRanks.top10Attacker.rank}}" points="{{ownRanks.top10Attacker.points}}"></tr>
					</tbody>
				</table>
			</div>
			...
			<div class="contentBox transparent">
				<h6 class="contentBoxHeader headerWithArrowEndings tableGreen">
					<div class="content" translate>Kingdom.Ranking.Defender</div>
				</h6>
				<table class="gradient" ng-class="{'inRank': ownRanks.top10Defender && ownRanks.top10Defender.rank < 3}">
					<thead>
						<tr><th colspan="3">&nbsp;</th></tr>
					</thead>
					<tbody class="ranks">
						<tr ng-repeat="i in [0, 1, 2]" ng-class="{'highlighted': kingdom.stats.top10Defender[i].playerId == player.data.playerId}"
							player-rank player-id="{{kingdom.stats.top10Defender[i].playerId}}" player-name="{{kingdom.stats.top10Defender[i].name}}" rank="{{i}}" points="{{kingdom.stats.top10Defender[i].points}}"></tr>
					</tbody>
					<tbody class="ownRank" ng-if="!ownRanks.top10Defender || ownRanks.top10Defender.rank > 2">
						<tr player-rank player-id="{{player.data.playerId}}" player-name="{{player.data.playerName}}" rank="{{ownRanks.top10Defender.rank}}" points="{{ownRanks.top10Defender.points}}"></tr>
					</tbody>
				</table>
			</div>
			...
			<div class="contentBox transparent">
				<h6 class="contentBoxHeader headerWithArrowEndings tableGreen">
					<div class="content" translate>Kingdom.Ranking.Climber</div>
				</h6>
				<table class="gradient" ng-class="{'inRank': ownRanks.top10Climber && ownRanks.top10Climber.rank < 3}">
					<thead>
						<tr><th colspan="3">&nbsp;</th></tr>
					</thead>
					<tbody class="ranks">
						<tr ng-repeat="i in [0, 1, 2]" ng-class="{'highlighted': kingdom.stats.top10Climber[i].playerId == player.data.playerId}"
							player-rank player-id="{{kingdom.stats.top10Climber[i].playerId}}" player-name="{{kingdom.stats.top10Climber[i].name}}" rank="{{i}}" points="{{kingdom.stats.top10Climber[i].points}}"></tr>
					</tbody>
					<tbody class="ownRank" ng-if="!ownRanks.top10Climber || ownRanks.top10Climber.rank > 2">
						<tr player-rank player-id="{{player.data.playerId}}" player-name="{{player.data.playerName}}" rank="{{ownRanks.top10Climber.rank}}" points="{{ownRanks.top10Climber.points}}"></tr>
					</tbody>
				</table>
			</div>
		</div>
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/Treasuries.html"><div class="treasurySlots" ng-controller="kingdomTreasuriesCtrl">
	<div class="contentWrapper" scrollable height-dependency="max">
		<div class="contentBox">
			<div class="contentBoxBody">
				<div class="treasurySlot contentBox gradient used" ng-repeat="village in villages" ng-if="village.influence > 0">
					<div class="contentBoxBody">
						<div class="villageName" ng-show="village.playerId == currentPlayer.data.playerId">
						...
						<div class="villageLevel" translate data="level: {{village.level}}, max: 4">
							Society.Kingdom.Treasuries.Slots.UsedTreasurySlot.Body.Level
						</div>
						...
						<div class="populationNumbers">
							...
							<span ng-if="village.currentTo < 10000">{{0 | bidiRatio : village.population : village.currentTo}}</span>
							<span ng-if="village.currentTo >= 10000">{{village.population}}</span>
						</div>
						...
						<div ng-if="village.influence <= 0" class="warning">
							<i class="symbol_warning_tiny_flat_red"></i>
							<span translate>Society.Kingdom.Treasuries.Slots.UsedTreasurySlot.Influence.Warning.NoTreasury</span>
						</div>


					</div>
				</div>
				<div class="treasurySlot contentBox gradient transforming" ng-repeat="slot in inTransformingSlots">
					<div class="contentBoxBody">
						<div class="treasurySlotHeader">
							<div class="villageName" ng-show="slot.data.playerId == currentPlayer.data.playerId">
								<span village-link villageId="{{slot.data.villageId}}" villageName="{{villages[slot.data.villageId].villageName}}"></span>
							</div>
							<div class="villageName" ng-show="slot.data.playerId != currentPlayer.data.playerId">
								<span player-link playerId="{{slot.data.playerId}}"></span> | <span village-link villageId="{{slot.data.villageId}}" villageName="{{villages[slot.data.villageId].villageName}}"></span>
							</div>
						</div>
						<div class="treasurySlotBody">
							<span translate>Society.Kingdom.Treasuries.Slots.TransformingTreasurySlot.Body</span>
						</div>
					</div>
				</div>
				<div class="treasurySlot contentBox gradient assigned" ng-repeat="slot in assignedTreasurySlots">
					<div class="contentBoxBody">
						<div class="treasurySlotHeader">
							<span player-link playerId="{{slot.data.playerId}}"></span>
							<i ng-if="currentPlayer.data.isKing"
							   class="action_delete_small_flat_black"
							   tooltip
							   tooltip-translate="Society.Kingdom.Treasuries.Slots.AssignedTreasurySlot.Body.Tooltip.Unassign"
							   clickable="deleteSlotPermission({{slot.data.slotId}})"></i>
						</div>
						<div class="treasurySlotBody">
							<span translate ng-if="::slot.data.playerId == player.data.kingId">Society.Kingdom.Treasuries.Slots.AssignedTreasurySlot.Body.Description.King</span>
							<span translate ng-if="::slot.data.playerId != player.data.kingId">Society.Kingdom.Treasuries.Slots.AssignedTreasurySlot.Body.Description.Duke</span>
						</div>
					</div>
				</div>

				<div ng-if="currentPlayer.data.isKing" class="treasurySlot contentBox gradient assignable" ng-repeat="n in [] | range:1:amountOfAssignableTreasurySlots">
					<div class="contentBoxBody">
						<div class="treasurySlotHeader">
							<h6 translate>Society.Kingdom.Treasuries.Slots.AssignableTreasurySlot.Header</h6>
							<div class="symbol_i_tiny_wrapper">
								<i class="symbol_i_tiny_flat_white" tooltip tooltip-translate="Society.Kingdom.Treasuries.Slots.AssignableTreasurySlot.Body.InfoTooltip"></i>
							</div>
						</div>
						<div class="treasurySlotBody">
							<span translate ng-if="!kingHasMaxSlots">Society.Kingdom.Treasuries.Slots.AssignableTreasurySlot.Body.All</span>
							<span translate ng-if="kingHasMaxSlots">Society.Kingdom.Treasuries.Slots.AssignableTreasurySlot.Body.OnlyDuke</span>
						</div>
					</div>
					<div dropdown data="dropdownData">{{option.name}} <span ng-bind-html="option.currentSlots | bidiRatio : option.currentSlots : option.maxSlotsOfPlayer"></span></div>
				</div>

				<div class="treasurySlot contentBox gradient next">
					<div class="contentBoxBody">
						<div class="treasurySlotHeader">
							<h6 translate>Society.Kingdom.Treasuries.Slots.NextTreasurySlot</h6>
						</div>
						<div class="treasurySlotBody">
							<div ng-bind-html="currentTreasures | bidiRatio : currentTreasures : nextTreasurySlot : true"></div>
							<div progressbar
								perc='{{percentageCurrentTreasures}}'
							></div>
						</div>
					</div>
				</div>
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/Tributes.html"><div ng-controller="kingdomTributesCtrl" class="tributes">
	<div scrollable>
		<div ng-include ng-if="player.isKing() && independentVillages.length > 0" src="'tpl/society/partials/kingdom/tributes/independentVillages.html'"></div>
		<div ng-include ng-if="(player.isKing() || player.isDuke()) && tributeVillages.length > 0" src="'tpl/society/partials/kingdom/tributes/tributeVillages.html'"></div>
		<div ng-include ng-if="(player.isKing() || player.isDuke()) && foreignVillages.length > 0" src="'tpl/society/partials/kingdom/tributes/foreignVillages.html'"></div>
		<div ng-include src="'tpl/society/partials/kingdom/tributes/ownVillages.html'"></div>
	</div>
</div></script>
<script type="text/ng-template" id="tpl/society/partials/kingdom/changeTag.html"><div ng-controller="kingdomChangeTagCtrl">
	<h6 class="headerColored" translate>Kingdom.NameYourKingdom</h6>

	<div class="inputContainer">
		<input class="text" maxlength="8" type="text" ng-model="newTag" placeholder="{{placeHolderKingdomTag}}">
	</div>
	<div class="error" ng-if="kingdomTagError">{{kingdomTagError}}</div>
	<div class="buttonFooter">
		<button clickable="renameKingdom()" ng-class="{disabled: !newTag}">
			<span translate>Kingdom.Button.Rename</span>
		</button>
		<button clickable="closeOverlay();" class="cancel">
			<span translate>Kingdom.Button.Cancel</span>
		</button>
	</div>
</div></script>
<script type="text/ng-template" id="tpl/society/partials/kingdom/editDescription.html"><div ng-controller="kingdomEditDescriptionCtrl" class="alliance kingdomEditDescription">
<h6 class="headerColored" translate>Kingdom.EditDescription.Description</h6>

	<div class="kingdomDescription contentBox colored">
		<div class="contentBoxBody" scrollable>
			<textarea class="description editDescription" maxlength="2000" ng-model="$parent.description" auto-focus="resetCursor"></textarea>
		</div>
	</div>
	<div class="buttonFooter">
		<div class="error">{{kingdomChangeDescriptionError}}</div>
		<button clickable="editDescription();">
			<span translate>Kingdom.EditDescription.Button.Accept</span>
		</button>
		<button clickable="closeOverlay();" class="cancel">
			<span translate>Button.Abort</span>
		</button>
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/editInternalInfo.html"><div class="internalInfos contentBox colored">
	<div class="contentBoxBody">
		<textarea ng-model="$parent.description.internalDescription"></textarea>
	</div>
</div>

<div class="buttonFooter">
	<button clickable="editInfos()">
		<span translate>Kingdom.EditInternalInfo.Button.Accept</span>
	</button>
	<button clickable="closeOverlay()" class="cancel">
		<span translate>Button.Abort</span>
	</button>
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/influenceBarTooltip.html"><h3 data="level: {{village.level}}" translate>
	Society.Kingdom.Treasuries.Slots.UsedTreasurySlot.Tooltip.Level
</h3>
<div class="horizontalLine"></div>
<span ng-show="village.currentTo >= 10000" translate>Society.Kingdom.Treasuries.Slots.UsedTreasurySlot.Tooltip.MaxLevel</span>
<span ng-show="village.currentTo< 10000" data="needed: {{village.currentTo}}" translate>Society.Kingdom.Treasuries.Slots.UsedTreasurySlot.Tooltip.PopulationForNextLevel</span></script>
<script type="text/ng-template" id="tpl/society/partials/kingdom/influenceCalculationTooltip.html"><h3 translate>Society.Kingdom.Treasuries.Slots.UsedTreasurySlot.Influence.Tooltip.Header</h3>
<div class="horizontalLine"></div>
<table class="transparent influenceTable">
	<tr>
		<th translate>Society.Kingdom.Treasuries.Slots.UsedTreasurySlot.Influence.Tooltip.Inhabitants</th>
		<td>{{village.population}}</td>
	</tr>
	<tr>
		<th data="value: {{village.treasureBonus}}" translate>Society.Kingdom.Treasuries.Slots.UsedTreasurySlot.Influence.Tooltip.TreasureBonus</th>
		<td>{{village.treasureBonusValue}}</td>
	</tr>
	<tr class="sumRow">
		<th translate>Society.Kingdom.Treasuries.Slots.UsedTreasurySlot.Influence.Tooltip.Total</th>
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/offerTreaty.html"><div class="inWindowPopup"
	 ng-class="{warning: overlayConfig['isAWarning']}">
	<div class="inWindowPopupHeader">
	...
	<div class="inWindowPopupContent">
		<div class="contentBox transparent">
			<h6 class="contentBoxHeader headerColored" translate>
				Kingdom.Diplomacy.OfferTreaty.KingdomName
			</h6>

			<div class="contentBoxBody">
				<serverautocomplete autocompletedata="kingdom" autocompletecb="searchCallback" ng-model="targetInput"></serverautocomplete>
			</div>
		</div>
		<div class="horizontalLine"></div>
		<div class="contentBox transparent offerType">
			<div class="contentBoxHeader" translate>
				Kingdom.Diplomacy.OfferTreaty.TreatyType
			</div>
			<div class="contentBoxBody">
				<div class="offerLabel">
					<label>
						<input type="radio" name="treatyType" ng-model="input.selectedTreaty" value="2">
						<span translate>Kingdom.Diplomacy.War</span>
					</label>
				</div>
				<div class="offerLabel">
					<label>
						<input type="radio" name="treatyType" ng-model="input.selectedTreaty" value="0">
						<span translate>Kingdom.Diplomacy.NAP</span>
					</label>
				</div>
				<div class="offerLabel">
					<label>
						<input type="radio" name="treatyType" ng-model="input.selectedTreaty" value="1">
						<span translate>Kingdom.Diplomacy.BND</span>
					</label>
				</div>
			</div>
		</div>
		<div class="buttonFooter">
			<div class="error">{{kingdomTreatyError}}</div>
			<button clickable="offerTreaty();" ng-class="{'disabled':((!selectedKingdom) || (input.selectedTreaty < 0))}">
				<span translate>Kingdom.Diplomacy.OfferTreaty.Button.Accept</span>
			</button>
			<button class="cancel" clickable="closeOverlay();">
				<span translate>Button.Abort</span>
			</button>
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/tributes/foreignVillages.html"><div class="foreignVillages contentBox transparent" ng-controller="foreignVillagesCtrl">
	<h6 class="contentBoxHeader headerWithArrowEndings tableGreen">
		<div class="content" translate>Kingdom.TributeOverview.ForeignVillages</div>
	</h6>
	<table class="gradient">
		<thead>
			<tr>
				<th><i class="village_village_small_flat_black"></i></th>
				<th>
					<i class="movement_tribute_small_flat_black"></i>
					<div class="symbol_i_tiny_wrapper">
						<i class="symbol_i_tiny_flat_white" tooltip tooltip-translate="Kingdom.TributeOverview.ForeignVillages.Info"></i>
					</div>
				</th>
			</tr>
		</thead>
		<tbody>
			<tr ng-repeat="village in foreignVillages | orderBy: '-data.population'">
				<td player-village village="village"></td>
				<td class="collect">
					<div ng-if="village.data.protectionGranted">
						<span translate ng-if="!influences[village.data.villageId]['connected'] && village.data.type !== Village.TYPE_GOVERNOR_NPC_VILLAGE">Kingdom.TributeOverview.NotConnected</span>
						<div ng-if="influences[village.data.villageId]['connected'] || village.data.type === Village.TYPE_GOVERNOR_NPC_VILLAGE">
							<village-tribute village="village" troop-movement="tributeOnTheWay[village.data.villageId]" current-server-time="currentServerTime"></village-tribute>
						</div>
					</div>
					<div ng-if="!village.data.protectionGranted">
						<button clickable="grantProtection({{village.data.villageId}})" ng-class="{npcVillageButton: village.data.villageId < 0}">
							<span translate>Kingdom.TributeOverview.ForeignVillages.GrantProtection</span>
						</button>
					</div>
				</td>
			</tr>
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/tributes/independentVillages.html"><div class="independentVillages contentBox transparent" ng-controller="independentVillagesCtrl">
	<h6 class="contentBoxHeader headerWithArrowEndings tableGreen">
		<div class="content" translate>Kingdom.NeutralGovernors</div>
	</h6>
	<table class="gradient">
		<thead>
			<tr>
				<th><i class="village_village_small_flat_black"></i></th>
				<th>
					<i class="action_invite_small_flat_black"></i>
					<div class="symbol_i_tiny_wrapper">
						<i class="symbol_i_tiny_flat_white" tooltip tooltip-translate="Kingdom.TributeOverview.IndependentGovernor.Info"></i>
					</div>
				</th>
			</tr>
		</thead>
		<tbody class="ranks">
			<tr ng-repeat="village in independentVillages | orderBy: '-data.population'">
				<td player-village village="village"></td>
				<td>
					<button ng-if="!invitations[village.data.playerId]" clickable="inviteToKingdom({{village.data.villageId}})" ng-class="{npcVillageButton: village.data.villageId < 0}">
						<span translate>ContextMenu.button.inviteToKingdom</span>
					</button>
					<div ng-if="invitations[village.data.playerId]">
						<span translate>Kingdom.TributeOverview.InvitationPending</span>
						<button clickable="cancelInvitation({{invitations[village.data.playerId]}})" class="cancel">
							<span translate>Button.Cancel</span>
						</button>
					</div>
				</td>
...
<script type="text/ng-template" id="tpl/society/partials/kingdom/tributes/ownVillages.html"><div class="ownVillages contentBox transparent" ng-controller="ownVillagesCtrl">
	<h6 ng-if="ownVillages.data.length > 0" class="contentBoxHeader headerWithArrowEndings tableGreen">
		<div class="content" translate>Kingdom.TributeOverview.OwnVillages</div>
	</h6>
	<table ng-if="ownVillages.data.length > 0" class="gradient">
		<thead>
			<tr>
				<th><i class="village_village_small_flat_black"></i></th>
				<th class="tributeProgressBar"><i class="movement_tribute_small_flat_black"></i></th>
				<th><i class="community_kingdom_small_flat_black"></i></th>
				<th class="denyTributes">
					<i class="tribute_denied_small_flat_black"></i>
					<i class="movement_tribute_small_flat_black"></i>
					<div class="symbol_i_tiny_wrapper">
						<i class="symbol_i_tiny_flat_white" tooltip tooltip-translate="Kingdom.TributeOverview.DenyTributeInfo"></i>
					</div>
				</th>
			</tr>
		</thead>
		<tbody class="ranks">
			<tr ng-repeat="village in ownVillages.data | orderBy: 'data.name'">
				<td player-village show-meta="false" village="village"></td>
				<td>
					<div tooltip tooltip-url="tpl/society/partials/kingdom/tributes/tributesProductionTooltip.html">
						<div progressbar type="green"
									 perc='{{village.data.tributePercentage}}'
									 marker="{{village.data.tributeTreasureMarker}}"
						></div>
				...
				<td>
					<kingdom-link kingdomId="{{village.data.belongsToKingdom}}"></kingdom-link>
				</td>
				<td class="denyTributes">
					<switch switch-name1="No" switch-name2="Yes" switch-callback="toggleDenyTributes" switch-model="village.data.allowTributeCollection" switch-id="village.data.villageId"></switch>
				</td>
			</tr>
		</tbody>
	</table>
	<p class="noVillages" ng-if="dataLoaded && independentVillages.length === 0 && tributeVillages.length === 0 && foreignVillages.length === 0 && ownVillages.data.length === 0" translate>Kingdom.TributeOverview.Empty</p>
</div></script>
<script type="text/ng-template" id="tpl/society/partials/kingdom/tributes/tributeVillages.html"><div class="tributeVillages contentBox transparent" ng-controller="tributeVillagesCtrl">
	<h6 class="contentBoxHeader headerWithArrowEndings tableYellow">
		<div class="content" translate>Kingdom.TributeOverview.TributeVillages</div>
	</h6>
	<table class="gradient">
		<thead>
			<tr>
				...
				<th>
					<i class="movement_tribute_small_flat_black"></i>
					<div class="symbol_i_tiny_wrapper">
						<i class="symbol_i_tiny_flat_white" tooltip tooltip-translate="Kingdom.TributeOverview.TributeVillages.Info"></i>
					</div>
				</th>
			</tr>
		</thead>
		<tbody>
			<tr ng-repeat="village in tributeVillages | orderBy: '-data.population'">
				<td player-village village="village"></td>
				<td class="collect" ng-class="{'notConnected': !influences[village.data.villageId]['connected']}">
					<span translate ng-if="!influences[village.data.villageId]['connected']">Kingdom.TributeOverview.NotConnected</span>
					<div ng-if="influences[village.data.villageId]['connected']">
						<village-tribute village="village" troop-movement="tributeOnTheWay[village.data.villageId]" current-server-time="currentServerTime"
							tribute-bonus-percent="tributeBonusPercent"></village-tribute>
					</div>
				</td>
			</tr>
			<tr class="collectAll" ng-if="tributeVillages.length >= 5">
				<td colspan="2">
					<button clickable="collectAll()"
							ng-class="{'disabled': !collectAllTributes.enabled}"
							tooltip
							tooltip-show="{{collectAllTributes.enabled}}"
							tooltip-class="tributesTooltip"
							tooltip-url="tpl/society/partials/kingdom/tributes/tributesTooltip.html">
						<span translate>Tribute.FetchAll</span>
					</button>
				</td>
			</tr>
		</tbody>
	</table>
	<table class="gradient notEnoughInfluence" ng-if="notEnoughInfluenceVillages.length > 0" ng-init="noInfluenceShow = false">
		<thead>
			<tr>
				<th colspan="2">
					<span class="expand" ng-click="noInfluenceShow = !noInfluenceShow" ng-class="{'opened': noInfluenceShow}"></span>
					<span translate data="amount: {{notEnoughInfluenceVillages.length}}">Kingdom.TributeOverview.TributeVillages.MoreVillages</span>
				</th>
			</tr>
		</thead>
		<tbody ng-if="noInfluenceShow">
			<tr ng-repeat="village in notEnoughInfluenceVillages | orderBy: '-data.population'">
				<td player-village village="village"></td>
				<td class="collect">
					<span class="influencePlayer" translate data="playerId: {{influences[village.data.villageId]['dominatingPlayerId']}}, playerName:">Kingdom.TributeOverview.NotEnoughInfluence</span>
					<button class="disabled" tooltip tooltip-translate="Kingdom.TributeOverview.NotEnoughInfluence.Tootlip"><span translate>Tribute.FetchSelected</span></button>
				</td>
			</tr>
		</tbody>
	</table>
</div></script>
<script type="text/ng-template" id="tpl/society/partials/kingdom/tributes/tributesProductionTooltip.html"><h3 translate>Kingdom.Governors.Tributes.ToolTip.ProductionHeadline</h3>

<div class="horizontalLine"></div>
<div class="capacity">{{village.data.tributeSum}} / {{village.data.tributesCapacity}}</div>

<div class="horizontalLine"></div>

<display-resources resources="village.data.calculatedTributes"
				   production-per-hour="village.data.tributeProductionDetail"
				   check-storage="false"
				   hide-crop="true"></display-resources>

<div ng-if="village.data.tributeTreasures > 0">
	<div class="horizontalLine"></div>
	<span class="treasureValue">
		<i class="unit_treasure_small_illu"></i>
		<span>{{village.data.tributeTreasures}}</span>
	</span>
</div></script>
<script type="text/ng-template" id="tpl/society/partials/kingdom/tributes/tributesTooltip.html"><h3 ng-if="village" translate>Tribute.FetchSelected</h3>
<h3 ng-if="!village" translate>Kingdom.TributeOverview.TributesDenied.CollectAll.Tooltip</h3>
<div class="horizontalLine"></div>
<div ng-if="troopMovement.time > currentServerTime">
	<i class="symbol_clock_small_flat_black duration"></i> <span class="countdown" countdown="{{troopMovement.time}}"></span>
	<div class="horizontalLine"></div>
	<display-resources resources="troopMovement.resources" check-storage="true" hide-crop="true"></display-resources>
</div>
<div ng-if="!(troopMovement.time > currentServerTime) && village.data.canFetchTributes">
	<i class="symbol_clock_small_flat_black duration"></i> {{durationToKingVillage|HHMMSS}}
	<div class="horizontalLine"></div>
	<display-resources resources="village.data.calculatedTributes" hide-crop="true"></display-resources>
</div>
<div ng-if="!(troopMovement.time > currentServerTime) && !village.data.canFetchTributes">
	<span ng-if="village">
		<i class="symbol_clock_small_flat_black duration"></i> <span data="inTime: {{village.data.timeUntilTributeFetch}}" translate>Kingdom.Governors.Tributes.ToolTip.FetchableIn</span>
		<div class="horizontalLine"></div>
	</span>
	<display-resources resources="village.data.calculatedTributes || tributeSum.resources" hide-crop="true"></display-resources>
</div>
<div ng-if="tributeSum.treasures > 0 || troopMovement.treasures > 0 || village.data.tributeTreasures > 0">
	<div class="horizontalLine"></div>
	<span class="treasureValue">
		<i class="unit_treasure_small_illu"></i>
		<span ng-if="village">{{troopMovement.time > currentServerTime ? troopMovement.treasures : village.data.tributeTreasures}}</span>
		<span ng-if="!village">{{tributeSum.treasures}}</span>
	</span>
</div>
<div ng-if="!(troopMovement.time > currentServerTime) && tributeBonusPercent > 0">
	<div class="horizontalLine"></div>
	<h3 translate>
		Tribute.StartBonus
	</h3>
	<div class="horizontalLine"></div>
	<display-resources resources="tributeBonusResources || tributeSum.bonusResources" additional-resources="village.data.calculatedTributes || tributeSum.resources" check-storage="false" hide-crop="true"></display-resources>
</div></script>
				...
				<div class="column target">
					...
					<div class="targetContainer">
						...
						<div ng-if="society.data.targetType == target.kingdom">
							...
							<kingdom-link kingdomId="{{targetObj.data.groupId}}"></kingdom-link>
						</div>
					</div>
				</div>
				<div class="column">
...
<script type="text/ng-template" id="tpl/statistics/statsKingdomsAttacker.html"><div>
	<h4 translate>Statistics.Kingdoms.Attacker.Title</h4>
	...
	<div pagination items-per-page="itemsPerPage"
		...
		<table>
			...
			<tbody>
			<tr ng-repeat="result in rankings" ng-class="{highlighted: result.kingdomId == player.data.kingdomId || result.rank == searchedRank}">
				<td>{{result.rank|rank}}.</td>
				<td><kingdom-link kingdomId="{{result.kingdomId}}"></kingdom-link></td>
...
<script type="text/ng-template" id="tpl/statistics/statsKingdomsDefender.html"><div>
	<h4 translate>Statistics.Kingdoms.Defender.Title</h4>
	...
	<div pagination items-per-page="itemsPerPage"
		...
		<table>
			...
			<tr ng-repeat="result in rankings" ng-class="{highlighted: result.kingdomId == player.data.kingdomId || result.rank == searchedRank}">
				<td>{{result.rank|rank}}.</td>
				<td class="nameColumn">
					<kingdom-link kingdomId="{{result.kingdomId}}"></kingdom-link>
				</td>
...
<script type="text/ng-template" id="tpl/statistics/statsKingdomsTop10.html"><div class="top10Ranking">
		...
		<div class="top10quarter" ng-repeat="top10 in top10Lists">
			...
			<table>
				...
				<tr>
					...
					<th class="player" translate>TableHeader.Kingdom</th>
				...
				<tr class="highlighted">
					...
					<td class="player">
						<kingdom-link kingdomId="{{top10.ownData[0].kingdomId}}"></kingdom-link>
					</td>
...
<script type="text/ng-template" id="tpl/statistics/statsKingdomsVictoryPoints.html"><div>
	<h4 translate>Statistics.Kingdoms.VictoryPoints.Title</h4>
	...
	<div pagination items-per-page="itemsPerPage"
		...
		<table>
			...
			<tr ng-repeat="result in rankings" ng-class="{highlighted: result.kingdomId == player.data.kingdomId || result.rank == searchedRank}">
				<td>{{result.rank|rank}}.</td>
				<td><kingdom-link kingdomId="{{result.kingdomId}}" kingdomName="{{result.name}}"></kingdom-link></td>
				<td>{{result.membersCount}}</td>
				<td>{{result.points/result.membersCount | number: 0}}</td>
				<td ng-if="result.bonus" tooltip tooltip-translate="Statistics.Kingdom.VictoryPoints.Total" tooltip-data="totalPoints: {{(1+result.bonus)*result.points | number: 0}}" tooltip-placement="above">{{result.points | number: 0}} <span class="pointsBonus">{{result.bonus * 100 | bidiNumber:'percent':true:false:false}}</span></td>
			...
			<div class="contentBoxBody">
				<table class="worldStatsTable transparent">
					...
					<tr>
						...
						<td>{{Math.floor((currentServerTime-stats.world.startTime)/86400)}}</td>
					</tr>
					<tr>
	...
	<div pagination items-per-page="itemsPerPage"
		...
		<table class="worldWonder">
			...
			<tr ng-repeat="result in rankings track by $index" ng-class="{highlighted: result.playerId == player.data.playerId || result.rank == searchedRank}">
				...
				<td class="nameColumn"><kingdom-link kingdomId="{{result.kingdomId}}"></kingdom-link></td>
				<td>{{result.level}}</td>
...
<script type="text/ng-template" id="tpl/tribeSelection/tribeSelection.html"><div class="tribeSelection" ng-controller="tribeSelectionCtrl">
	<div class="selectionHeaderContainer">
		<div class="trapezoidalOrnament onTop"></div>
		<div class="selectionHeader">
			<div class="fromEnding"></div>
			<div class="content" translate>TribeSelection.Header</div>
			<div class="toEnding"></div>
		</div>
	</div>
	<div class="closeOverlay" clickable="backToLobby()" ng-class="{hover: cancelHover}"
		 on-pointer-over="cancelHover = true" on-pointer-out="cancelHover = false">
		<i ng-class="{action_cancel_small_flat_black: !cancelHover, action_cancel_small_flat_green: cancelHover}"></i>
	</div>
	<div class="tribeCarouselContainer">
		<div class="tribeSpotlight"></div>
		<div class="carouselArrow fromArrow" clickable="moveCarousel(config['direction'] == 'rtl')"></div>
		<div class="carouselArrow toArrow" clickable="moveCarousel(config['direction'] != 'rtl')"></div>
		<div class="tribeCarousel {{carouselMoveClass}}">
			<div ng-repeat="n in []|range:1:3" class="carouselItem {{TRIBE_NAME[n]}} position{{selectedTribeId - n + (selectedTribeId - n < 0 ? 3 : 0)}}"
				 clickable="selectedTribeId != n ? moveCarousel(selectedTribeId - n + (selectedTribeId - n < 0 ? 3 : 0) > 1) : ''">
				<i class="tribeImage {{TRIBE_NAME[n]}}"></i>
	...
	<div class="tribeSelectionContainer tkDialogue">
		...
		<div class="selectionContainer dialogueContent tribeInfo">
			<div class="infoHeader" translate options="{{selectedTribeId}}">Tribe_?</div>
			<div class="infoIconContainer" tooltip tooltip-url="tpl/tribeSelection/partials/infoTooltip.html" tooltip-placement="above">
				<i class="symbol_i_medium_flat_white"></i>
			</div>
			<hr>
			<ul class="{{tribe}}">
				<li ng-repeat="n in []|range:1:3"><i class="star"></i><span translate options="{{selectedTribeId}},{{n}}">TribeSelection.TribeDescription_?_?</span></li>
			</ul>
		</div>
		<div class="selectionContainer dialogueContent tribeAction">
			<button class="selectButton" clickable="selectTribe()"><span translate>TribeSelection.Button.Select</span></button>
			<div class="options">
				<div class="serverOption">
					<span translate>TribeSelection.Option.Server</span>:
					<span class="serverName">{{config['gameWorld']}}</span>
				</div>
			</div>
		</div>
	</div>
</div></script>
<script type="text/ng-template" id="tpl/tribeSelection/partials/infoTooltip.html"><div class="selectTribeTooltip tribe{{selectedTribeId}}">
	<div class="category" translate>SelectTribe.TribeDescription.Category.Merchants</div>
	<ul options="{{selectedTribeId}}" translate>SelectTribe.TribeDescription.Category.Merchants.Tribe_?</ul>
	<div class="category" translate>SelectTribe.TribeDescription.Category.Troops</div>
	<ul options="{{selectedTribeId}}" translate>SelectTribe.TribeDescription.Category.Troops.Tribe_?</ul>
	<div class="category" translate>SelectTribe.TribeDescription.Category.Specials</div>
	<ul options="{{selectedTribeId}}" translate>SelectTribe.TribeDescription.Category.Specials.Tribe_?</ul>
</div>
</script>
	...
	<div class="troopsDetailHeader" ng-if="!showInputFields">
		...
		<div class="troopsTitle" ng-if="status != 'send' && !isGroup">
			...
			<div ng-if="status == 'incoming'">
				<i class="{{movementIcon}}" tooltip tooltip-translate="TroopMovementInfo_{{movementGroup}}" tooltip-placement="above"></i>
				<span ng-if="!oasis">
...
<script type="text/ng-template" id="tpl/user/partials/avatar_image.html"><div class="heroImage {{gender}}" ng-class="::class" rerender="rerender">
	<img ng-if="playerId == robberId" class="npcAvatar npcKing avatar_robber_illustration" src="layout/images/x.gif" ng-style="{transform: 'scale({{scale || 1}})'}" />
	<img ng-if="playerId == npcGovernorId" class="npcAvatar npcGovernor avatar_npcGovernor_illustration" src="layout/images/x.gif" ng-style="{transform: 'scale({{scale || 1}})'}" />
</div>
</script>
	...
	<table class="villagesTable lined">
		...
		<tbody>
			<tr ng-repeat="oases in oasesList" ng-if="oases.data.usedByVillage != 0 && oases.data.rank > 0" ng-init="$parent.$parent.anyOasisInUse=true">
				...
				<td class="iconCol"><i class="symbol_generalTroops_small_flat_black"></i></td>
...
<script type="text/ng-template" id="tpl/welcomeScreen/welcomeScreen.html"><div ng-controller="welcomeScreenCtrl">
	<div class="prestigeInfo">
		<div progressbar perc="{{prestigeRankPerc}}"></div>
		<h6 class="headerTrapezoidal">
			<div class="content"
				 tooltip
				 tooltip-translate-switch="{
				 ...
				 tooltip-data="prestige:{{player.data.prestige}},nextLevelPrestige:{{player.data.nextLevelPrestige}}"
				 tooltip-class="welcomeScreen"
				 clickable="openWindow('profile', {'profileTab': 'prestige', 'playerId': player.data.playerId})">
				<span class="rankLeft" translate data="rank:{{currentPrestigeRank}}">WelcomeScreen.Prestige.Rank</span>
				<prestige-stars ng-if="player.filled" playerId="{{player.data.playerId}}" size="small"></prestige-stars>
				<span class="rankRight" ng-if="!maxPrestige" translate data="rank:{{currentPrestigeRank + 1}}">WelcomeScreen.Prestige.Rank</span>
			</div>
		</h6>
	</div>
	...
	<div class="activities container">
		<div class="containerHeader">
			<span translate>WelcomeScreen.Activities.Header</span>
		</div>
		<div class="activitiesButtonContainer">
			<div class="clickableContainer activitiesButton adventureButton"
				 clickable="openWindow('hero', {'herotab': 'Adventures'})"
				 tooltip
				 tooltip-translate="WelcomeScreen.Tooltip.Adventure"
				 tooltip-data="adventurePoints:{{AdventurePoints}}">
				<i class="welcomescreen_adventure_big_illu" ng-class="{disabled: AdventurePoints == 0}"></i>
				<div class="horizontalLine double"></div>
				<span class="activitiesAmount">{{AdventurePoints}}</span>
			</div>
			<div class="clickableContainer activitiesButton robberButton"
				 clickable="openPage('map')"
				 tooltip
				 tooltip-translate="WelcomeScreen.Tooltip.Robbers"
				 tooltip-data="robberCamps:{{RobberCampsAmount}}">
				<i class="welcomescreen_robbers_big_illu" ng-class="{disabled: RobberCampsAmount == 0}"></i>
				<div class="horizontalLine double"></div>
				<span class="activitiesAmount">{{RobberCampsAmount}}</span>
			</div>
			<div class="clickableContainer activitiesButton cardGameButton"
				 clickable="openWindow('hero', {'herotab': 'CardGame'})"
				 tooltip
				 tooltip-translate="WelcomeScreen.Tooltip.Cardgame"
				 tooltip-data="cardgameRolls:{{cardGameRollsSum}}">
				<i class="welcomescreen_cardgame_big_illu" ng-class="{disabled: cardGameRollsSum == 0}"></i>
				<div class="horizontalLine double"></div>
				<span class="activitiesAmount">{{cardGameRollsSum}}</span>
			</div>
			<div class="clickableContainer activitiesButton last prestigeButton"
				 clickable="openWindow('profile', {'profileTab': 'prestige', 'playerId': player.data.playerId})"
				 tooltip
				 tooltip-translate="WelcomeScreen.Tooltip.Prestige"
				 tooltip-data="completedPrestigeTasks:{{CompletedPrestigeTasks}},totalPrestigeTasks:{{TotalPrestigeTasks}}">
				<i class="welcomescreen_prestige_big_illu"></i>
				<div class="horizontalLine double"></div>
				<span class="activitiesAmount prestigeTasks">{{CompletedPrestigeTasks}} / {{TotalPrestigeTasks}}</span>
			</div>
		</div>
	</div>
	<div class="activityStream container">
		<div class="containerHeader">
			<span translate>WelcomeScreen.ActivityStream.Header</span>
		</div>
		<div class="activityStreamContainer containerBody">
			<div ng-repeat="stream in activityStream.data" class="activity" ng-init="showSubStream = false">
				<div class="activityWrapper">
					<div class="activityStreamActivity" ng-class="{open: showSubStream}" ng-click="clickHandler(this)">
						<i class="{{activityStream.imageMap[stream.activityId]}}"></i>
						<div class="activityText">
							<span translate options="{{stream.activityId}}" data="{{stream.translateData}}"
									   ng-if="([ACTIVITY_STREAM_TYPES.TYPE_NEW_GOVERNOR,ACTIVITY_STREAM_TYPES.TYPE_WW_MILESTONE].indexOf(stream.activityId) == -1) || (stream.activityId == ACTIVITY_STREAM_TYPES.TYPE_NEW_GOVERNOR && stream.subStreams.length  > 1) || (stream.activityId == ACTIVITY_STREAM_TYPES.TYPE_WW_MILESTONE && (ownKingdom != stream.kingdomId || (stream.kingdomId == 0 && player.data.playerId != stream.playerId)))"
							>WelcomeScreen.ActivityStream.Stream_?
							</span>
							<span translate options="{{stream.activityId}}" data="{{stream.subStreams[0].translateData}}" ng-if="stream.activityId == ACTIVITY_STREAM_TYPES.TYPE_NEW_GOVERNOR && stream.subStreams.length == 1">WelcomeScreen.ActivityStream.Stream_?_single</span>
							<span translate options="{{stream.activityId}}" data="{{stream.translateData}}" ng-if="stream.activityId == ACTIVITY_STREAM_TYPES.TYPE_WW_MILESTONE && ownKingdom == stream.kingdomId && stream.kingdomId > 0">WelcomeScreen.ActivityStream.Stream_?_ownKingdom</span>
							<span translate options="{{stream.activityId}}" data="{{stream.translateData}}" ng-if="stream.activityId == ACTIVITY_STREAM_TYPES.TYPE_WW_MILESTONE && player.data.playerId == stream.playerId && stream.kingdomId == 0">WelcomeScreen.ActivityStream.Stream_?_own</span>
						</div>
					</div>

					<div class="activityStreamActivity subActivity {{Object.keys(activityStream.customSubStreams).indexOf(stream.activityId)}}" ng-click="clickHandler(this, true)" ng-if="showSubStream" ng-repeat="subStream in stream.subStreams" ng-switch="stream.activityId">
						<span translate options="{{stream.activityId}}, {{subStream.buildingType}}" data="{{subStream.translateData}}" ng-switch-when="5">
							WelcomeScreen.ActivityStream.Stream_?.SubStream_?
						</span>
						<span translate options="{{stream.activityId}}" data="{{subStream.translateData}}" ng-switch-default>
							WelcomeScreen.ActivityStream.Stream_?.SubStream
						</span>
					</div>
				</div>
	...
	<div class="kingdomStatus container">
		<div class="containerHeader">
			<span translate>WelcomeScreen.KingdomStatus.Header</span>
		</div>
		<div class="kingdomStatusButtonContainer containerBody">
			<div class="clickableContainer kingdomStatusButton"
				 clickable="openWindow('society', {'subtab': 'Territory'})">
				<i class="welcomescreen_kingdom_big_illu"></i>
				<div class="horizontalLine"></div>
				<div class="headerTrapezoidal">
					<span class="content" translate>WelcomeScreen.KingdomStatus.Rank</span>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/ng-template" id="tpl/worldEnded/tabs/KingdomRanking.html"><div ng-repeat="r in kingdomRankings" class="rankingEntryBox player kingdom">
	<i class="header kingdom {{r.type}}" ng-class="{endOfWorld_populationTop_large_illu: r.type == 'population',
													endOfWorld_deffPointsTop_large_illu: r.type == 'treasures',
													endOfWorld_sizeTop_large_illu: r.type == 'size'}"></i>
	<div class="content">
		<div class="headerRow">
		...
		<div class="entry" ng-repeat="entry in r.ranking">
			...
			<div class="data truncated">
				{{entry.rank|rank}}.
				<kingdom-link kingdomId="{{entry.kingdomId}}" kingdomName="{{entry.name}}"></kingdom-link>
				<div class="points">
			...
			<div class="endGamePrestigeStars" ng-if="config.balancing.features.prestige" tooltip tooltip-translate="Prestige.Level">
				<prestige-stars playerId="{{entry.playerId}}" size="tiny"></prestige-stars>
			</div>
		</div>
		...
		<div class="entry own" ng-if="ownKingdomRankings[r.type] != null && ownKingdomRankings[r.type].rank >= 10">
			...
			<div class="data truncated">
				{{ownKingdomRankings[r.type].rank|rank}}.
				<kingdom-link kingdomId="{{ownKingdomRankings[r.type].kingdomId}}" kingdomName="{{ownKingdomRankings[r.type].name}}"></kingdom-link>
				<div class="points">
...
<script type="text/ng-template" id="tpl/worldEnded/tabs/PlayerRanking.html"><div ng-repeat="r in playerRankings" class="rankingEntryBox player">
	<i class="header player  endOfWorld_{{r.type}}Top_large_illu"></i>
	<div class="content">
		<div class="headerRow">
		...
		<div class="entry" ng-repeat="entry in r.ranking">
			...
			<div class="data truncated">
				{{entry.rank|rank}}.
				<span player-link playerId="{{entry.playerId}}" playerName="{{entry.playerName}}"></span>
				<div class="points">
		...
		<div class="entry own" ng-if="ownRankings[r.type] != null && ownRankings[r.type].rank >= 10">
			...
			<div class="data truncated">
				{{ownRankings[r.type].rank|rank}}.
				<span player-link playerId="{{ownRankings[r.type].playerId}}" playerName="{{ownRankings[r.type].playerName}}"></span>
				<div class="points">
...
<script type="text/ng-template" id="tpl/worldEnded/tabs/Prestige.html"><div class="worldEndPrestige">
    ...
    <div class="rankingEntryBox">
        <div class="header prestigeCup report_cup_big_illu">
            <div class="points">{{prestige.kingdomPrestige | bidiNumber:'':true:true}}</div>
        </div>
        <div class="content">
            <div class="rankingTitle" translate>WorldEndPrestige.RankingName.Kingdom</div>
            <div class="horizontalLine"></div>
            <div tooltip tooltip-url="tpl/worldEnded/partials/bonusTooltip.html" tooltip-data="custom:{{!hasKingdomPrestige}},customText:{{kingdomTooltipNoKingdomText}},title:{{kingdomTooltipTitle}},earnedPrestige:{{prestige.weeklyPrestige}},bonusPercent:{{prestige.kingdomBonus}},totalGained:{{prestige.kingdomPrestige}}">
                <i class="feature_prestige_small_flat_black bonusPrestigeCupIcon"></i><span translate>WorldEndPrestige.Bonus</span>{{prestige.kingdomPrestige}}
            </div>
            <div class="horizontalLine"></div>
            <div>
                <span translate>WorldEndPrestige.Rank</span>
                <span ng-if="prestige.kingdomRank >= 0">{{prestige.kingdomRank | rank}}</span>
                <span ng-if="prestige.kingdomRank == -1"> - </span>
            </div>
        </div>
    </div>
    <div class="rankingEntryBox">
...
<script type="text/ng-template" id="tpl/worldEnded/tabs/VictoryPointsRanking.html"><div class="rankingEntryBox rank1 alliance">
	<i class="header endOfWorld_alliance_rank1_large_illu"></i>
	<div class="content">
		<div class="headerRow">
			<i class="unit_victoryPoints_small_flat_black"></i>&#160;{{victoryPoints[0].victoryPoints}}
		</div>
		<div class="horizontalLine"></div>
		<div class="name">
			<kingdom-link kingdomId="{{victoryPoints[0].kingdomId}}"></kingdom-link>
			<br>
			&#160;
		</div>
		<div class="horizontalLine belowRank1"></div>
		<div class="horizontalLine belowRank4"></div>
		<div class="king rank{{$index+1}}" ng-repeat="member in victoryPoints[0].members">
			<div class="playerHead">
				<avatar-image scale="0.62" player-id="{{member.playerId}}" class="avatar"></avatar-image>
			</div>
			<br>
			<span player-link playerId="{{member.playerId}}"></span>
			<br>
			&#160;
		</div>
		<div class="showAll">
			<div class="horizontalLine"></div>
			<span clickable="openOverlay('kingdomMemberList', {kingdomId: victoryPoints[0].kingdomId})" translate>
				WorldEnded.Kingdom.ShowAll
			</span>
		</div>
	</div>
</div>
...
<div ng-repeat="r in [2,3]" class="rankingEntryBox rank{{r}} alliance">
	<i class="header endOfWorld_alliance_rank{{$index+2}}_large_illu"></i>
	<div class="content">
		<div class="headerRow">
			<i class="unit_victoryPoints_small_flat_black"></i>&#160;{{victoryPoints[$index+1].victoryPoints}}
		</div>
		<div class="horizontalLine"></div>
		<div class="name truncated">
			<kingdom-link kingdomId="{{victoryPoints[$index+1].kingdomId}}"></kingdom-link>
		</div>
		<div class="horizontalLine"></div>
		<div ng-repeat="member in victoryPoints[$index+1].members">
			<span player-link playerId="{{member.playerId}}"></span>
		</div>
		<div class="horizontalLine"></div>
		<div class="showAll">
			<div class="horizontalLine"></div>
			<span clickable="openOverlay('kingdomMemberList', {kingdomId: {{victoryPoints[$index+1].kingdomId}} })" translate>
				WorldEnded.Kingdom.ShowAll
			</span>
		</div>
	</div>
...
<script type="text/ng-template" id="tpl/worldEnded/tabs/WorldWonder.html"><div ng-repeat="r in [1,2,3,4,5,6,7]" class="rankingEntryBox rank{{r}}">
	...
	<div class="content" ng-if="worldWonders[$index].playerId >= 100">
		...
		<div class="horizontalLine"></div>
		<div class="alliance">
			<kingdom-link kingdomId="{{worldWonders[$index].kingdomId}}"></kingdom-link>
		</div>
		<div class="horizontalLine"></div>
		<div class="player">
...
<script type="text/ng-template" id="tpl/worldEndedModal/worldEndedModal.html"><div ng-controller="worldEndedSummaryCtrl">
	<div clickable="openWindow('worldEnded')">
		<div class="headerBackground endOfWorld_headerBackground_huge_illu">
			<div class="worldWonder endOfWorld_wwVillage_huge_illu"></div>
		</div>
		<i class="winnerKingdom endOfWorld_winnerKingdom_large_illu"></i>
		<div class="textBox">
