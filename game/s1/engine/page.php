...
class Page {
    ...
    public function getURI($index = null) {
        $str = str_replace(str_replace('engine', '', dirname(__FILE__)), '', $_SERVER['DOCUMENT_ROOT'] . $_SERVER['REQUEST_URI']);
        $page = explode('/', $str);
    ...
    public function getFullURI() {
        return str_replace(str_replace('engine', '', dirname(__FILE__)), '', $_SERVER['DOCUMENT_ROOT'] . $_SERVER['REQUEST_URI']);
    }
